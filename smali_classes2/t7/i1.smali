...
.method static b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    invoke-static {p0, v1}, Lt7/i1;->a(Ljava/lang/Class;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public static e(Ljava/lang/Class;Ljava/lang/Iterable;Ljava/lang/ClassLoader;Lt7/i1$b;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p2}, Lt7/i1;->d(Ljava/lang/ClassLoader;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, Lt7/i1;->b(Ljava/lang/Class;Ljava/lang/Iterable;)Ljava/lang/Iterable;
    ...
    :cond_0
    invoke-static {p0, p2}, Lt7/i1;->c(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/lang/Iterable;
    ...
    invoke-interface {p3, p2}, Lt7/i1$b;->a(Ljava/lang/Object;)Z
    ...
    :cond_2
    new-instance p0, Lt7/i1$a;

    invoke-direct {p0, p3}, Lt7/i1$a;-><init>(Lt7/i1$b;)V
