...
.field private final d:Ld7/s;

.field private e:Lio/flutter/plugin/editing/m$c;

.field private f:Ld7/s$b;
...
.field private n:Ld7/s$e;

.field private o:Z


# direct methods
.method public constructor <init>(Landroid/view/View;Ld7/s;Lio/flutter/plugin/platform/x;)V
    .locals 3
    ...
    invoke-direct {v0, v1, p1}, Lio/flutter/plugin/editing/e;-><init>(Ld7/s$e;Landroid/view/View;)V
    ...
    :cond_1
    iput-object p2, p0, Lio/flutter/plugin/editing/m;->d:Ld7/s;
    ...
    invoke-virtual {p2, p1}, Ld7/s;->n(Ld7/s$f;)V

    invoke-virtual {p2}, Ld7/s;->k()V
...
.method private G(Ld7/s$b;)V
    ...
    iget-object v0, p1, Ld7/s$b;->j:Ld7/s$b$a;
    ...
    :cond_1
    iget-object v0, p1, Ld7/s$b;->l:[Ld7/s$b;
    ...
    iget-object v0, v0, Ld7/s$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v2, Ld7/s$b;->j:Ld7/s$b$a;

    if-eqz v3, :cond_3

    iget-object v4, p0, Lio/flutter/plugin/editing/m;->g:Landroid/util/SparseArray;

    iget-object v5, v3, Ld7/s$b$a;->a:Ljava/lang/String;
    ...
    iget-object v3, v3, Ld7/s$b$a;->c:Ld7/s$e;

    iget-object v3, v3, Ld7/s$e;->a:Ljava/lang/String;
...
.method private static m(Ld7/s$e;Ld7/s$e;)Z
    .locals 7

    iget v0, p0, Ld7/s$e;->e:I

    iget v1, p0, Ld7/s$e;->d:I

    sub-int/2addr v0, v1

    iget v1, p1, Ld7/s$e;->e:I

    iget v2, p1, Ld7/s$e;->d:I
    ...
    iget-object v4, p0, Ld7/s$e;->a:Ljava/lang/String;

    iget v5, p0, Ld7/s$e;->d:I
    ...
    iget-object v5, p1, Ld7/s$e;->a:Ljava/lang/String;

    iget v6, p1, Ld7/s$e;->d:I
...
.method private static s(Ld7/s$c;ZZZZLd7/s$d;)I
    .locals 1

    iget-object p4, p0, Ld7/s$c;->a:Ld7/s$g;

    sget-object v0, Ld7/s$g;->c:Ld7/s$g;
    ...
    :cond_0
    sget-object v0, Ld7/s$g;->f:Ld7/s$g;

    if-ne p4, v0, :cond_3

    const/4 p1, 0x2

    iget-boolean p2, p0, Ld7/s$c;->b:Z
    ...
    :cond_1
    iget-boolean p0, p0, Ld7/s$c;->c:Z
    ...
    :cond_3
    sget-object p0, Ld7/s$g;->m:Ld7/s$g;
    ...
    :cond_4
    sget-object p0, Ld7/s$g;->r:Ld7/s$g;
    ...
    sget-object v0, Ld7/s$g;->n:Ld7/s$g;
    ...
    :cond_6
    sget-object v0, Ld7/s$g;->o:Ld7/s$g;
    ...
    :cond_7
    sget-object v0, Ld7/s$g;->p:Ld7/s$g;
    ...
    :cond_8
    sget-object v0, Ld7/s$g;->q:Ld7/s$g;
    ...
    :cond_9
    sget-object v0, Ld7/s$g;->d:Ld7/s$g;
    ...
    :cond_a
    sget-object v0, Ld7/s$g;->e:Ld7/s$g;
    ...
    :cond_e
    :goto_1
    sget-object p1, Ld7/s$d;->b:Ld7/s$d;
    ...
    :cond_f
    sget-object p1, Ld7/s$d;->c:Ld7/s$d;
    ...
    :cond_10
    sget-object p1, Ld7/s$d;->d:Ld7/s$d;
...
.method private v(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->f:Ld7/s$b;

    iget-object v0, v0, Ld7/s$b;->j:Ld7/s$b$a;
...
.method C(ILd7/s$b;)V
    ...
    iput-object p2, p0, Lio/flutter/plugin/editing/m;->f:Ld7/s$b;
    ...
    iget-object v0, p2, Ld7/s$b;->j:Ld7/s$b$a;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v0, v0, Ld7/s$b$a;->c:Ld7/s$e;
    ...
    invoke-direct {p1, v0, v2}, Lio/flutter/plugin/editing/e;-><init>(Ld7/s$e;Landroid/view/View;)V

    iput-object p1, p0, Lio/flutter/plugin/editing/m;->h:Lio/flutter/plugin/editing/e;

    invoke-direct {p0, p2}, Lio/flutter/plugin/editing/m;->G(Ld7/s$b;)V
...
.method D(Landroid/view/View;Ld7/s$e;)V
    .locals 2
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->n:Ld7/s$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Ld7/s$e;->b()Z
    ...
    invoke-static {v0, p2}, Lio/flutter/plugin/editing/m;->m(Ld7/s$e;Ld7/s$e;)Z
    ...
    invoke-static {v0, v1}, Lr6/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iput-object p2, p0, Lio/flutter/plugin/editing/m;->n:Ld7/s$e;

    iget-object v0, p0, Lio/flutter/plugin/editing/m;->h:Lio/flutter/plugin/editing/e;

    invoke-virtual {v0, p2}, Lio/flutter/plugin/editing/e;->n(Ld7/s$e;)V
...
.method E(Landroid/view/View;)V
    ...
    iget-object v0, v0, Ld7/s$b;->g:Ld7/s$c;

    if-eqz v0, :cond_1

    iget-object v0, v0, Ld7/s$c;->a:Ld7/s$g;
...
.method public a(ZZZ)V
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/m;->n:Ld7/s$e;
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/m;->n:Ld7/s$e;

    iget-object v2, v2, Ld7/s$e;->a:Ljava/lang/String;
    ...
    iget v2, v1, Ld7/s$e;->b:I

    if-ne p1, v2, :cond_1

    iget v2, v1, Ld7/s$e;->c:I

    if-ne p2, v2, :cond_1

    iget v2, v1, Ld7/s$e;->d:I

    if-ne p3, v2, :cond_1

    iget v1, v1, Ld7/s$e;->e:I
    ...
    invoke-static {v2, v1}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lio/flutter/plugin/editing/m;->f:Ld7/s$b;

    iget-boolean v1, v1, Ld7/s$b;->e:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, Lio/flutter/plugin/editing/m;->d:Ld7/s;
    ...
    invoke-virtual {v1, v2, v0}, Ld7/s;->q(ILjava/util/ArrayList;)V
    ...
    :cond_3
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->d:Ld7/s;
    ...
    invoke-virtual/range {v0 .. v6}, Ld7/s;->p(ILjava/lang/String;IIII)V

    :goto_2
    new-instance v6, Ld7/s$e;
    ...
    invoke-direct/range {v0 .. v5}, Ld7/s$e;-><init>(Ljava/lang/String;IIII)V

    iput-object v6, p0, Lio/flutter/plugin/editing/m;->n:Ld7/s$e;
...
.method public j(Landroid/util/SparseArray;)V
    ...
    check-cast v3, Ld7/s$b;

    if-eqz v3, :cond_4

    iget-object v3, v3, Ld7/s$b;->j:Ld7/s$b$a;
    ...
    invoke-direct/range {v5 .. v10}, Ld7/s$e;-><init>(Ljava/lang/String;IIII)V

    iget-object v5, v3, Ld7/s$b$a;->a:Ljava/lang/String;

    iget-object v6, v0, Ld7/s$b$a;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lio/flutter/plugin/editing/e;->n(Ld7/s$e;)V

    goto :goto_1

    :cond_3
    iget-object v3, v3, Ld7/s$b$a;->a:Ljava/lang/String;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/plugin/editing/m;->d:Ld7/s;

    iget-object v0, p0, Lio/flutter/plugin/editing/m;->e:Lio/flutter/plugin/editing/m$c;

    iget v0, v0, Lio/flutter/plugin/editing/m$c;->b:I

    invoke-virtual {p1, v0, v1}, Ld7/s;->r(ILjava/util/HashMap;)V
...
.method l()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/m;->f:Ld7/s$b;

    invoke-direct {p0, v0}, Lio/flutter/plugin/editing/m;->G(Ld7/s$b;)V
...
.method public n(Landroid/view/View;Lio/flutter/embedding/android/b0;Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v1, v0, Ld7/s$b;->g:Ld7/s$c;

    iget-boolean v2, v0, Ld7/s$b;->a:Z

    iget-boolean v3, v0, Ld7/s$b;->b:Z

    iget-boolean v4, v0, Ld7/s$b;->c:Z

    iget-boolean v5, v0, Ld7/s$b;->d:Z

    iget-object v6, v0, Ld7/s$b;->f:Ld7/s$d;

    invoke-static/range {v1 .. v6}, Lio/flutter/plugin/editing/m;->s(Ld7/s$c;ZZZZLd7/s$d;)I
    ...
    iget-object v2, p0, Lio/flutter/plugin/editing/m;->f:Ld7/s$b;

    iget-boolean v2, v2, Ld7/s$b;->d:Z
    ...
    iget-object v1, v1, Ld7/s$b;->h:Ljava/lang/Integer;
    ...
    iget-object v2, v1, Ld7/s$b;->i:Ljava/lang/String;
    ...
    iget-object v0, v1, Ld7/s$b;->k:[Ljava/lang/String;

    if-eqz v0, :cond_8

    invoke-static {p3, v0}, Ly/b;->d(Landroid/view/inputmethod/EditorInfo;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lio/flutter/plugin/editing/m;->d:Ld7/s;
    ...
    invoke-direct/range {v1 .. v7}, Lio/flutter/plugin/editing/d;-><init>(Landroid/view/View;ILd7/s;Lio/flutter/plugin/editing/d$a;Lio/flutter/plugin/editing/e;Landroid/view/inputmethod/EditorInfo;)V
...
.method public o()V
    ...
    invoke-virtual {v0, v1}, Ld7/s;->n(Ld7/s$f;)V
...
.method public y(Landroid/view/ViewStructure;I)V
    ...
    :cond_0
    iget-object v2, v0, Lio/flutter/plugin/editing/m;->f:Ld7/s$b;

    iget-object v2, v2, Ld7/s$b;->j:Ld7/s$b$a;

    iget-object v2, v2, Ld7/s$b$a;->a:Ljava/lang/String;
    ...
    check-cast v7, Ld7/s$b;

    iget-object v7, v7, Ld7/s$b;->j:Ld7/s$b$a;
    ...
    iget-object v9, v7, Ld7/s$b$a;->b:[Ljava/lang/String;
    ...
    iget-object v8, v7, Ld7/s$b$a;->d:Ljava/lang/String;
    ...
    iget-object v6, v7, Ld7/s$b$a;->c:Ld7/s$e;

    iget-object v6, v6, Ld7/s$e;->a:Ljava/lang/String;
