...
.field private d:Ld7/k$j;

.field private e:I

.field final f:Ld7/k$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Ld7/k;Lio/flutter/plugin/platform/g$d;)V
    .locals 1
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/g;->f:Ld7/k$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/g;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/g;->b:Ld7/k;

    invoke-virtual {p2, v0}, Ld7/k;->l(Ld7/k$h;)V
...
.method private C(Ld7/k$j;)V
    ...
    invoke-direct {v2, v0, v1}, Landroidx/core/view/o2;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v3, p1, Ld7/k$j;->b:Ld7/k$d;
    ...
    :cond_1
    invoke-virtual {v2, v4}, Landroidx/core/view/o2;->b(Z)V

    goto :goto_0

    :cond_2
    invoke-virtual {v2, v6}, Landroidx/core/view/o2;->b(Z)V

    :cond_3
    :goto_0
    iget-object v3, p1, Ld7/k$j;->a:Ljava/lang/Integer;
    ...
    :cond_4
    iget-object v3, p1, Ld7/k$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Ld7/k$j;->e:Ld7/k$d;
    ...
    :cond_6
    invoke-virtual {v2, v4}, Landroidx/core/view/o2;->a(Z)V

    goto :goto_1

    :cond_7
    invoke-virtual {v2, v6}, Landroidx/core/view/o2;->a(Z)V

    :cond_8
    :goto_1
    iget-object v2, p1, Ld7/k$j;->d:Ljava/lang/Integer;
    ...
    :cond_9
    iget-object v2, p1, Ld7/k$j;->f:Ljava/lang/Integer;
    ...
    :cond_a
    iget-object v2, p1, Ld7/k$j;->g:Ljava/lang/Boolean;
    ...
    :cond_b
    iput-object p1, p0, Lio/flutter/plugin/platform/g;->d:Ld7/k$j;
...
.method static synthetic a(Lio/flutter/plugin/platform/g;Ld7/k$i;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->s(Ld7/k$i;)V
...
.method static synthetic c(Lio/flutter/plugin/platform/g;Ld7/k$e;)Ljava/lang/CharSequence;
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->r(Ld7/k$e;)Ljava/lang/CharSequence;
...
.method static synthetic g(Lio/flutter/plugin/platform/g;)Ld7/k;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/g;->b:Ld7/k;

    return-object p0
.end method

.method static synthetic h(Lio/flutter/plugin/platform/g;Ld7/k$c;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->x(Ld7/k$c;)V
...
.method static synthetic j(Lio/flutter/plugin/platform/g;Ld7/k$k;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->z(Ld7/k$k;)V
...
.method static synthetic m(Lio/flutter/plugin/platform/g;Ld7/k$j;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/g;->C(Ld7/k$j;)V
...
.method private r(Ld7/k$e;)Ljava/lang/CharSequence;
    .locals 6
    ...
    sget-object v2, Ld7/k$e;->b:Ld7/k$e;
    ...
    invoke-static {v0, p1}, Lr6/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Lr6/b;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private s(Ld7/k$i;)V
    .locals 1

    sget-object v0, Ld7/k$i;->b:Ld7/k$i;
...
.method private t()V
    ...
    invoke-interface {v0}, Landroidx/activity/v;->h()Landroidx/activity/OnBackPressedDispatcher;
...
.method private w(Z)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/plugin/platform/g$d;->f(Z)V

    :cond_0
    return-void
.end method

.method private x(Ld7/k$c;)V
    .locals 4
    ...
    iget-object v2, p1, Ld7/k$c;->b:Ljava/lang/String;

    const/4 v3, 0x0

    iget p1, p1, Ld7/k$c;->a:I
    ...
    iget-object v1, p1, Ld7/k$c;->b:Ljava/lang/String;
...
.method private z(Ld7/k$k;)V
    .locals 1

    sget-object v0, Ld7/k$k;->b:Ld7/k$k;
    ...
    :cond_0
    sget-object v0, Ld7/k$k;->c:Ld7/k$k;
    ...
    :cond_1
    sget-object v0, Ld7/k$k;->d:Ld7/k$k;
    ...
    :cond_2
    sget-object v0, Ld7/k$k;->e:Ld7/k$k;
...
.method public E()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/g;->d:Ld7/k$j;

    if-eqz v0, :cond_0

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/g;->C(Ld7/k$j;)V
...
.method public q()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/g;->b:Ld7/k;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Ld7/k;->l(Ld7/k$h;)V
