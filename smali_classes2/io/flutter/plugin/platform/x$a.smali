...
.method public static synthetic j(Lio/flutter/plugin/platform/x$a;Lio/flutter/plugin/platform/h0;FLd7/m$b;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x$a;->k(Lio/flutter/plugin/platform/h0;FLd7/m$b;)V

    return-void
.end method

.method private synthetic k(Lio/flutter/plugin/platform/h0;FLd7/m$b;)V
    .locals 5
    ...
    invoke-direct {v0, v1, p1}, Ld7/m$c;-><init>(II)V

    invoke-interface {p3, v0}, Ld7/m$b;->a(Ld7/m$c;)V
...
.method public b(II)V
    ...
    invoke-static {v1, p1}, Lr6/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public c(Ld7/m$d;)V
    ...
    invoke-static {v0, p1}, Lio/flutter/plugin/platform/x;->j(Lio/flutter/plugin/platform/x;Ld7/m$d;)V

    iget-object v0, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lio/flutter/plugin/platform/x;->M(Ld7/m$d;Z)Lio/flutter/plugin/platform/j;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    invoke-static {v1, v0, p1}, Lio/flutter/plugin/platform/x;->u(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Ld7/m$d;)V

    return-void
.end method

.method public d(Ld7/m$d;)J
    .locals 5
    ...
    invoke-static {v2, v3}, Ls7/h;->f(Landroid/view/View;[Ljava/lang/Class;)Z
    ...
    iget-object v1, p1, Ld7/m$d;->h:Ld7/m$d$a;

    sget-object v2, Ld7/m$d$a;->b:Ld7/m$d$a;
    ...
    invoke-static {v1, v0, p1}, Lio/flutter/plugin/platform/x;->A(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Ld7/m$d;)J
    ...
    invoke-virtual {v1, v0, p1}, Lio/flutter/plugin/platform/x;->I(Lio/flutter/plugin/platform/j;Ld7/m$d;)J
...
.method public e(Ld7/m$e;Ld7/m$b;)V
    .locals 4

    iget-object v0, p0, Lio/flutter/plugin/platform/x$a;->a:Lio/flutter/plugin/platform/x;

    iget-wide v1, p1, Ld7/m$e;->b:D
    ...
    invoke-direct {v3, p0, p1, v2, p2}, Lio/flutter/plugin/platform/w;-><init>(Lio/flutter/plugin/platform/x$a;Lio/flutter/plugin/platform/h0;FLd7/m$b;)V
    ...
    invoke-direct {p1, v0, v1}, Ld7/m$c;-><init>(II)V

    invoke-interface {p2, p1}, Ld7/m$b;->a(Ld7/m$c;)V
...
.method public h(Ld7/m$f;)V
    .locals 4

    iget v0, p1, Ld7/m$f;->a:I
    ...
    invoke-virtual {v2, v1, p1, v3}, Lio/flutter/plugin/platform/x;->x0(FLd7/m$f;Z)Landroid/view/MotionEvent;
    ...
    invoke-static {v3, p1}, Lr6/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1, v3}, Lio/flutter/plugin/platform/x;->x0(FLd7/m$f;Z)Landroid/view/MotionEvent;
...
.method public i(I)V
    ...
    :try_start_0
    invoke-interface {v0}, Lio/flutter/plugin/platform/j;->dispose()V
    :try_end_0
    ...
    invoke-static {v1, v2, v0}, Lr6/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
