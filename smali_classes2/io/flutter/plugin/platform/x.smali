...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/x;->v:Ld7/m$g;
...
.method static synthetic A(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Ld7/m$d;)J
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/x;->J(Lio/flutter/plugin/platform/j;Ld7/m$d;)J
...
.method private H(Lio/flutter/plugin/platform/j;Ld7/m$d;)V
    .locals 1
    ...
    invoke-static {p2, p1}, Lr6/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method private J(Lio/flutter/plugin/platform/j;Ld7/m$d;)J
    .locals 10
    ...
    invoke-static {v1, v0}, Lr6/b;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v7, p2, Ld7/m$d;->a:I

    new-instance v9, Lio/flutter/plugin/platform/v;

    invoke-direct {v9, p0, p2}, Lio/flutter/plugin/platform/v;-><init>(Lio/flutter/plugin/platform/x;Ld7/m$d;)V
    ...
    iget-object v1, p2, Ld7/m$d;->b:Ljava/lang/String;
...
.method private R()V
    ...
    iget-object v1, p0, Lio/flutter/plugin/platform/x;->v:Ld7/m$g;

    invoke-interface {v1, v0}, Ld7/m$g;->i(I)V
...
.method private T(Ld7/m$d;)V
    .locals 3

    iget v0, p1, Ld7/m$d;->g:I
...
.method private U(Z)V
    ...
    invoke-virtual {v4}, Lio/flutter/embedding/android/l;->d()V
...
.method private synthetic Z(Ld7/m$d;Landroid/view/View;Z)V
    .locals 0

    if-eqz p3, :cond_0

    iget-object p2, p0, Lio/flutter/plugin/platform/x;->g:Ld7/m;

    iget p1, p1, Ld7/m$d;->a:I

    invoke-virtual {p2, p1}, Ld7/m;->d(I)V
...
.method private synthetic a0(Ld7/m$d;Landroid/view/View;Z)V
    .locals 0
...
.method private static e0(Lio/flutter/view/TextureRegistry;)Lio/flutter/plugin/platform/o;
    ...
    invoke-static {v2, v0}, Lr6/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static synthetic f(Lio/flutter/plugin/platform/x;Ld7/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x;->a0(Ld7/m$d;Landroid/view/View;Z)V
...
.method private f0(Lio/flutter/plugin/platform/j;)V
    ...
    invoke-static {p1, v0}, Lr6/b;->e(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p1, v0}, Lio/flutter/plugin/platform/j;->onFlutterViewAttached(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic g(Lio/flutter/plugin/platform/x;Ld7/m$d;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/x;->Z(Ld7/m$d;Landroid/view/View;Z)V
...
.method static synthetic j(Lio/flutter/plugin/platform/x;Ld7/m$d;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/x;->T(Ld7/m$d;)V
...
.method private t0()V
    ...
    invoke-static {v0, v1}, Lr6/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic u(Lio/flutter/plugin/platform/x;Lio/flutter/plugin/platform/j;Ld7/m$d;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/x;->H(Lio/flutter/plugin/platform/j;Ld7/m$d;)V
...
# virtual methods
.method public C(Landroid/content/Context;Lio/flutter/view/TextureRegistry;Ls6/a;)V
    .locals 1
    ...
    invoke-direct {p1, p3}, Ld7/m;-><init>(Ls6/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/x;->g:Ld7/m;

    iget-object p2, p0, Lio/flutter/plugin/platform/x;->v:Ld7/m$g;

    invoke-virtual {p1, p2}, Ld7/m;->e(Ld7/m$g;)V
...
.method public F(Lio/flutter/embedding/android/t;)V
    ...
    invoke-interface {v0, v1}, Lio/flutter/plugin/platform/j;->onFlutterViewAttached(Landroid/view/View;)V
...
.method public I(Lio/flutter/plugin/platform/j;Ld7/m$d;)J
    .locals 9
    ...
    invoke-direct {v0, p0, p2}, Lio/flutter/plugin/platform/u;-><init>(Lio/flutter/plugin/platform/x;Ld7/m$d;)V
...
.method public M(Ld7/m$d;Z)Lio/flutter/plugin/platform/j;
    .locals 3

    iget-object v0, p0, Lio/flutter/plugin/platform/x;->a:Lio/flutter/plugin/platform/m;

    iget-object v1, p1, Ld7/m$d;->b:Ljava/lang/String;
    ...
    iget-object v2, p1, Ld7/m$d;->i:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/k;->getCreateArgsCodec()Le7/i;

    move-result-object v1

    iget-object v2, p1, Ld7/m$d;->i:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Le7/i;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    :goto_0
    iget v2, p1, Ld7/m$d;->a:I

    invoke-virtual {v0, p2, v2, v1}, Lio/flutter/plugin/platform/k;->create(Landroid/content/Context;ILjava/lang/Object;)Lio/flutter/plugin/platform/j;
    ...
    iget-object p1, p1, Ld7/m$d;->b:Ljava/lang/String;
...
.method public N()V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/android/l;->d()V
...
.method public O()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/x;->g:Ld7/m;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Ld7/m;->e(Ld7/m$g;)V

    :cond_0
    invoke-virtual {p0}, Lio/flutter/plugin/platform/x;->N()V

    iput-object v1, p0, Lio/flutter/plugin/platform/x;->g:Ld7/m;
...
.method public P()V
    ...
    invoke-interface {v1}, Lio/flutter/plugin/platform/j;->onFlutterViewDetached()V
...
.method X(I)V
    ...
    invoke-direct {v1, v2, v3, v4}, Lv6/a;-><init>(Landroid/content/Context;FLio/flutter/embedding/android/c;)V
    ...
    invoke-virtual {v1, v2}, Lv6/a;->setOnDescendantFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V
...
.method public k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lv6/a;->a(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
...
.method public x0(FLd7/m$f;Z)Landroid/view/MotionEvent;
    .locals 20

    move-object/from16 v0, p2

    iget-wide v1, v0, Ld7/m$f;->p:J
    ...
    iget-object v3, v0, Ld7/m$f;->g:Ljava/lang/Object;
    ...
    iget-object v1, v0, Ld7/m$f;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v1, v0, Ld7/m$f;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v6

    iget v8, v0, Ld7/m$f;->d:I

    iget v9, v0, Ld7/m$f;->e:I

    iget v12, v0, Ld7/m$f;->h:I

    iget v13, v0, Ld7/m$f;->i:I

    iget v14, v0, Ld7/m$f;->j:F

    iget v15, v0, Ld7/m$f;->k:F

    iget v1, v0, Ld7/m$f;->l:I

    iget v3, v0, Ld7/m$f;->m:I

    iget v2, v0, Ld7/m$f;->n:I

    iget v0, v0, Ld7/m$f;->o:I
