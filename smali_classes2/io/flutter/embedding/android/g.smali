...
.method private g(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->B()Ljava/lang/String;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->l()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, v0, v2}, Ls6/a$c;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->t()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->g()Landroid/app/Activity;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lio/flutter/embedding/engine/d$b;->i(Ls6/a$c;)Lio/flutter/embedding/engine/d$b;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->i()Ljava/util/List;
...
.method private j(Lio/flutter/embedding/android/t;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->D()Lio/flutter/embedding/android/e0;
...
.method private k()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->j()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/g$c;->z()Ljava/lang/String;
    ...
    invoke-interface {v3}, Lio/flutter/embedding/android/g$c;->l()Ljava/lang/String;
    ...
    invoke-static {v3, v2}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lio/flutter/embedding/android/g;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->o()Ld7/j;

    move-result-object v2

    invoke-virtual {v2, v0}, Ld7/j;->c(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v0, v1, v3}, Ls6/a$c;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->i()Ljava/util/List;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Ls6/a;->k(Ls6/a$c;Ljava/util/List;)V
...
.method A(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->i()Lx6/b;

    move-result-object v0

    invoke-interface {v0, p1, p2, p3}, Lx6/b;->onRequestPermissionsResult(I[Ljava/lang/String;[I)Z
    ...
    invoke-static {v1, p1}, Lr6/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method B(Landroid/os/Bundle;)V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/g$c;->k()Z
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->u()Ld7/o;

    move-result-object v1

    invoke-virtual {v1, v0}, Ld7/o;->j([B)V

    :cond_1
    iget-object v0, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->v()Z
    ...
    invoke-interface {v0, p1}, Lx6/b;->a(Landroid/os/Bundle;)V
...
.method C()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->l()Ld7/g;

    move-result-object v0

    invoke-virtual {v0}, Ld7/g;->e()V
...
.method D(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->k()Z
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->u()Ld7/o;

    move-result-object v0

    invoke-virtual {v0}, Ld7/o;->h()[B
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/engine/a;->i()Lx6/b;

    move-result-object v1

    invoke-interface {v1, v0}, Lx6/b;->b(Landroid/os/Bundle;)V
...
.method G(I)V
    ...
    invoke-virtual {v0}, Ls6/a;->n()V

    iget-object v0, p0, Lio/flutter/embedding/android/g;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->x()Ld7/r;

    move-result-object v0

    invoke-virtual {v0}, Ld7/r;->a()V
...
.method H()V
    ...
    invoke-static {v1, v0}, Lr6/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method K()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/g$c;->j()Ljava/lang/String;
    ...
    invoke-interface {v1, v4}, Lio/flutter/embedding/android/g$c;->p(Landroid/content/Context;)Lio/flutter/embedding/engine/a;
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/g$c;->s()Ljava/lang/String;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->C()Lio/flutter/embedding/engine/g;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->k()Z
...
.method L(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->j()Ld7/b;

    move-result-object v0

    invoke-virtual {v0, p1}, Ld7/b;->d(Landroid/window/BackEvent;)V
...
.method M(Landroid/window/BackEvent;)V
    ...
    invoke-virtual {v0, p1}, Ld7/b;->e(Landroid/window/BackEvent;)V
...
.method public d()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->w()Z
...
.method r(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lx6/b;->onActivityResult(IILandroid/content/Intent;)Z
...
.method s(Landroid/content/Context;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/g$c;->v()Z
    ...
    invoke-static {p1, v0}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lio/flutter/embedding/android/g;->b:Lio/flutter/embedding/engine/a;

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->i()Lx6/b;

    move-result-object p1

    iget-object v0, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {v0}, Lio/flutter/embedding/android/g$c;->a()Landroidx/lifecycle/g;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lx6/b;->d(Lio/flutter/embedding/android/d;Landroidx/lifecycle/g;)V

    :cond_1
    iget-object p1, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {p1}, Lio/flutter/embedding/android/g$c;->g()Landroid/app/Activity;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/g;->b:Lio/flutter/embedding/engine/a;

    invoke-interface {p1, v0, v1}, Lio/flutter/embedding/android/g$c;->m(Landroid/app/Activity;Lio/flutter/embedding/engine/a;)Lio/flutter/plugin/platform/g;
    ...
    invoke-interface {p1, v0}, Lio/flutter/embedding/android/g$c;->r(Lio/flutter/embedding/engine/a;)V
...
.method t()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->o()Ld7/j;

    move-result-object v0

    invoke-virtual {v0}, Ld7/j;->a()V
...
.method u(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-static {p1, p2}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0}, Lio/flutter/embedding/android/g;->l()V

    iget-object p2, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {p2}, Lio/flutter/embedding/android/g$c;->D()Lio/flutter/embedding/android/e0;

    move-result-object p2

    sget-object p3, Lio/flutter/embedding/android/e0;->a:Lio/flutter/embedding/android/e0;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->E()Lio/flutter/embedding/android/f0;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/g$c;->A(Lio/flutter/embedding/android/m;)V
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/g$c;->E()Lio/flutter/embedding/android/f0;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/g$c;->q(Lio/flutter/embedding/android/n;)V
    ...
    invoke-interface {p2}, Lio/flutter/embedding/android/g$c;->o()Z
...
.method w()V
    ...
    invoke-interface {v1, v2}, Lio/flutter/embedding/android/g$c;->y(Lio/flutter/embedding/engine/a;)V

    iget-object v1, p0, Lio/flutter/embedding/android/g;->a:Lio/flutter/embedding/android/g$c;

    invoke-interface {v1}, Lio/flutter/embedding/android/g$c;->v()Z
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/g$c;->j()Ljava/lang/String;
...
.method x(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Lx6/b;->onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Ld7/j;->b(Ljava/lang/String;)V
