...
.field private final B:Lio/flutter/embedding/engine/renderer/d;
...
.field private p:Lg7/b;

.field private q:Lio/flutter/plugin/editing/m;

.field private r:Lio/flutter/plugin/editing/f;

.field private s:Lf7/b;

.field private t:Lio/flutter/embedding/android/b0;

.field private u:Lio/flutter/embedding/android/c;
...
.field private final y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lio/flutter/embedding/android/m;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/t;->f:Ljava/util/Set;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Lio/flutter/embedding/android/t;->o:Ljava/util/Set;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/t;->z:Lio/flutter/view/g$k;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/t;->A:Landroid/database/ContentObserver;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/t;->B:Lio/flutter/embedding/engine/renderer/d;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/t;->C:Lu/a;

    iput-object p3, p0, Lio/flutter/embedding/android/t;->a:Lio/flutter/embedding/android/m;

    iput-object p3, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lio/flutter/embedding/android/n;)V
    ...
    iput-object p3, p0, Lio/flutter/embedding/android/t;->b:Lio/flutter/embedding/android/n;
...
.method private C()V
    ...
    invoke-static {v0, v1}, Lr6/b;->g(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->t()Lio/flutter/embedding/engine/renderer/FlutterRenderer;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method static synthetic f(Lio/flutter/embedding/android/t;)Lio/flutter/embedding/engine/a;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;
...
.method static synthetic g(Lio/flutter/embedding/android/t;Z)Z
    ...
    iput-boolean p1, p0, Lio/flutter/embedding/android/t;->m:Z
...
.method static synthetic h(Lio/flutter/embedding/android/t;)Ljava/util/Set;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/t;->f:Ljava/util/Set;
...
.method static synthetic i(Lio/flutter/embedding/android/t;)Lio/flutter/embedding/android/l;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/t;->c:Lio/flutter/embedding/android/l;
...
.method private o()Lio/flutter/embedding/android/t$g;
    ...
    sget-object v0, Lio/flutter/embedding/android/t$g;->c:Lio/flutter/embedding/android/t$g;
    ...
    sget-object v0, Lio/flutter/embedding/android/t$g;->b:Lio/flutter/embedding/android/t$g;
    ...
    :cond_3
    sget-object v0, Lio/flutter/embedding/android/t$g;->d:Lio/flutter/embedding/android/t$g;

    return-object v0

    :cond_4
    sget-object v0, Lio/flutter/embedding/android/t$g;->a:Lio/flutter/embedding/android/t$g;
...
.method private u()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->a:Lio/flutter/embedding/android/m;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->a:Lio/flutter/embedding/android/m;
    ...
    :cond_0
    iget-object v1, p0, Lio/flutter/embedding/android/t;->b:Lio/flutter/embedding/android/n;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->b:Lio/flutter/embedding/android/n;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->c:Lio/flutter/embedding/android/l;
...
.method private x()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/t;->c:Lio/flutter/embedding/android/l;
...
.method public A(Ljava/lang/Runnable;)V
    ...
    invoke-static {v1, p1}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/t;->e:Lio/flutter/embedding/engine/renderer/e;
    ...
    :cond_1
    iput-object v0, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;

    const/4 v0, 0x0

    iput-object v0, p0, Lio/flutter/embedding/android/t;->e:Lio/flutter/embedding/engine/renderer/e;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;
    ...
    :cond_2
    iget-object v1, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;
...
.method B()V
    ...
    sget-object v0, Ld7/p$c;->c:Ld7/p$c;

    goto :goto_1

    :cond_1
    sget-object v0, Ld7/p$c;->b:Ld7/p$c;

    :goto_1
    iget-object v3, p0, Lio/flutter/embedding/android/t;->w:Landroid/view/textservice/TextServicesManager;
    ...
    iget-object v4, p0, Lio/flutter/embedding/android/t;->w:Landroid/view/textservice/TextServicesManager;
    ...
    :goto_2
    iget-object v4, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v4}, Lio/flutter/embedding/engine/a;->v()Ld7/p;

    move-result-object v4

    invoke-virtual {v4}, Ld7/p;->d()Ld7/p$b;
    ...
    invoke-virtual {v4, v5}, Ld7/p$b;->f(F)Ld7/p$b;
    ...
    invoke-virtual {v4, v5}, Ld7/p$b;->c(Landroid/util/DisplayMetrics;)Ld7/p$b;

    move-result-object v4

    invoke-virtual {v4, v3}, Ld7/p$b;->d(Z)Ld7/p$b;
    ...
    :cond_4
    invoke-virtual {v3, v1}, Ld7/p$b;->b(Z)Ld7/p$b;
    ...
    invoke-virtual {v1, v2}, Ld7/p$b;->g(Z)Ld7/p$b;

    move-result-object v1

    invoke-virtual {v1, v0}, Ld7/p$b;->e(Ld7/p$c;)Ld7/p$b;

    move-result-object v0

    invoke-virtual {v0}, Ld7/p$b;->a()V
...
.method public autofill(Landroid/util/SparseArray;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->q:Lio/flutter/plugin/editing/m;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->t:Lio/flutter/embedding/android/b0;

    invoke-virtual {v0, p1}, Lio/flutter/embedding/android/b0;->a(Landroid/view/KeyEvent;)Z
...
.method public getAccessibilityNodeProvider()Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->v:Lio/flutter/view/g;
...
.method public getBinaryMessenger()Le7/c;
    .locals 1

    iget-object v0, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->k()Ls6/a;
...
.method public l(Lio/flutter/embedding/engine/renderer/d;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->f:Ljava/util/Set;
...
.method public n(Lio/flutter/embedding/engine/a;)V
    ...
    :cond_1
    iput-object p1, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;
    ...
    iput-boolean v2, p0, Lio/flutter/embedding/android/t;->m:Z

    iget-object v2, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;

    invoke-interface {v2, v0}, Lio/flutter/embedding/engine/renderer/e;->c(Lio/flutter/embedding/engine/renderer/FlutterRenderer;)V

    iget-object v2, p0, Lio/flutter/embedding/android/t;->B:Lio/flutter/embedding/engine/renderer/d;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->n()Ld7/i;

    move-result-object v2

    invoke-direct {v0, p0, v2}, Lg7/b;-><init>(Lg7/b$c;Ld7/i;)V

    iput-object v0, p0, Lio/flutter/embedding/android/t;->p:Lg7/b;
    ...
    invoke-virtual {v2}, Lio/flutter/embedding/engine/a;->y()Ld7/s;

    move-result-object v2

    iget-object v3, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v3}, Lio/flutter/embedding/engine/a;->q()Lio/flutter/plugin/platform/x;

    move-result-object v3

    invoke-direct {v0, p0, v2, v3}, Lio/flutter/plugin/editing/m;-><init>(Landroid/view/View;Ld7/s;Lio/flutter/plugin/platform/x;)V

    iput-object v0, p0, Lio/flutter/embedding/android/t;->q:Lio/flutter/plugin/editing/m;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/t;->w:Landroid/view/textservice/TextServicesManager;

    new-instance v2, Lio/flutter/plugin/editing/f;

    iget-object v3, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v3}, Lio/flutter/embedding/engine/a;->w()Ld7/q;

    move-result-object v3

    invoke-direct {v2, v0, v3}, Lio/flutter/plugin/editing/f;-><init>(Landroid/view/textservice/TextServicesManager;Ld7/q;)V

    iput-object v2, p0, Lio/flutter/embedding/android/t;->r:Lio/flutter/plugin/editing/f;
    :try_end_0
    ...
    invoke-static {v1, v0}, Lr6/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    :goto_0
    iget-object v0, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;

    invoke-virtual {v0}, Lio/flutter/embedding/engine/a;->m()Lf7/b;

    move-result-object v0

    iput-object v0, p0, Lio/flutter/embedding/android/t;->s:Lf7/b;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/t;->t:Lio/flutter/embedding/android/b0;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/t;->u:Lio/flutter/embedding/android/c;

    new-instance v0, Lio/flutter/view/g;

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->h()Ld7/a;
    ...
    invoke-direct/range {v3 .. v8}, Lio/flutter/view/g;-><init>(Landroid/view/View;Ld7/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/plugin/platform/r;)V

    iput-object v0, p0, Lio/flutter/embedding/android/t;->v:Lio/flutter/view/g;

    iget-object v1, p0, Lio/flutter/embedding/android/t;->z:Lio/flutter/view/g$k;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->v:Lio/flutter/view/g;
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/t;->A:Landroid/database/ContentObserver;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->o:Ljava/util/Set;
    ...
    :cond_3
    iget-boolean p1, p0, Lio/flutter/embedding/android/t;->m:Z

    if-eqz p1, :cond_4

    iget-object p1, p0, Lio/flutter/embedding/android/t;->B:Lio/flutter/embedding/engine/renderer/d;

    invoke-interface {p1}, Lio/flutter/embedding/engine/renderer/d;->e()V
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1}, Landroidx/core/view/j2;->a(Landroid/view/WindowInsets;)Landroid/graphics/Insets;

    move-result-object v2

    iget-object v3, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    :cond_4
    invoke-static {p1, v4}, Landroidx/core/view/n2;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;

    move-result-object v1

    iget-object v2, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    invoke-static {p1, v1}, Landroidx/core/view/n2;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {p1}, Landroidx/core/view/h2;->a(Landroid/view/WindowInsets;)Landroid/view/DisplayCutout;
    ...
    :cond_5
    sget-object v1, Lio/flutter/embedding/android/t$g;->a:Lio/flutter/embedding/android/t$g;
    ...
    :cond_6
    iget-object v5, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
    ...
    sget-object v5, Lio/flutter/embedding/android/t$g;->c:Lio/flutter/embedding/android/t$g;

    if-eq v1, v5, :cond_9

    sget-object v5, Lio/flutter/embedding/android/t$g;->d:Lio/flutter/embedding/android/t$g;
    ...
    sget-object v3, Lio/flutter/embedding/android/t$g;->b:Lio/flutter/embedding/android/t$g;

    if-eq v1, v3, :cond_c

    sget-object v3, Lio/flutter/embedding/android/t$g;->d:Lio/flutter/embedding/android/t$g;
    ...
    iget-object p1, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method protected onAttachedToWindow()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/t;->x:Lio/flutter/embedding/android/g0;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0}, Ls7/h;->e(Landroid/content/Context;)Landroid/app/Activity;

    move-result-object v0

    iget-object v1, p0, Lio/flutter/embedding/android/t;->x:Lio/flutter/embedding/android/g0;
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/t;->C:Lu/a;

    invoke-virtual {v1, v0, v2, v3}, Lio/flutter/embedding/android/g0;->a(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lu/a;)V
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->s:Lf7/b;

    invoke-virtual {v0, p1}, Lf7/b;->d(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0}, Ls7/h;->c(Landroid/content/Context;Ls7/h$a;)V
...
.method public onCreateInputConnection(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->t:Lio/flutter/embedding/android/b0;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->x:Lio/flutter/embedding/android/g0;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lio/flutter/embedding/android/t;->C:Lu/a;

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/g0;->b(Lu/a;)V
...
.method public onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->u:Lio/flutter/embedding/android/c;
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-static {p4, p3}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p3, p0, Lio/flutter/embedding/android/t;->y:Lio/flutter/embedding/engine/renderer/FlutterRenderer$g;
...
.method public p()V
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;

    invoke-interface {v0}, Lio/flutter/embedding/engine/renderer/e;->a()V
...
.method public s()V
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->A:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->q:Lio/flutter/plugin/editing/m;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->r:Lio/flutter/plugin/editing/f;
    ...
    :cond_2
    iget-object v1, p0, Lio/flutter/embedding/android/t;->p:Lg7/b;

    if-eqz v1, :cond_3

    invoke-virtual {v1}, Lg7/b;->c()V
    ...
    iget-object v3, p0, Lio/flutter/embedding/android/t;->B:Lio/flutter/embedding/engine/renderer/d;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/t;->e:Lio/flutter/embedding/engine/renderer/e;

    if-eqz v1, :cond_4

    iget-object v2, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;

    iget-object v3, p0, Lio/flutter/embedding/android/t;->c:Lio/flutter/embedding/android/l;

    if-ne v2, v3, :cond_4

    iput-object v1, p0, Lio/flutter/embedding/android/t;->d:Lio/flutter/embedding/engine/renderer/e;
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/t;->n:Lio/flutter/embedding/engine/a;
...
.method protected setWindowInfoListenerDisplayFeatures(Landroidx/window/layout/WindowLayoutInfo;)V
    ...
    invoke-static {v2, v3}, Lr6/b;->f(Ljava/lang/String;Ljava/lang/String;)V
