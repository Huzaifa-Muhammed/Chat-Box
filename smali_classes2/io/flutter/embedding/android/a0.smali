...
.method public constructor <init>(Le7/c;)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/a0;->a:Le7/c;
...
.method private static e(Landroid/view/KeyEvent;)Lio/flutter/embedding/android/w$b;
    ...
    sget-object p0, Lio/flutter/embedding/android/w$b;->c:Lio/flutter/embedding/android/w$b;
    ...
    sget-object p0, Lio/flutter/embedding/android/w$b;->d:Lio/flutter/embedding/android/w$b;

    goto :goto_1

    :cond_3
    sget-object p0, Lio/flutter/embedding/android/w$b;->b:Lio/flutter/embedding/android/w$b;
...
.method private i(Landroid/view/KeyEvent;Lio/flutter/embedding/android/b0$d$a;)Z
    ...
    :goto_5
    sget-object v0, Lio/flutter/embedding/android/w$b;->b:Lio/flutter/embedding/android/w$b;
    ...
    sget-object v0, Lio/flutter/embedding/android/w$b;->d:Lio/flutter/embedding/android/w$b;
    ...
    :cond_a
    sget-object v0, Lio/flutter/embedding/android/w$b;->c:Lio/flutter/embedding/android/w$b;

    :cond_b
    move-object v1, v8

    :goto_7
    sget-object v2, Lio/flutter/embedding/android/w$b;->d:Lio/flutter/embedding/android/w$b;
    ...
    :cond_d
    sget-object v2, Lio/flutter/embedding/android/w$b;->b:Lio/flutter/embedding/android/w$b;
    ...
    sget-object v3, Lio/flutter/embedding/android/w$a;->b:Lio/flutter/embedding/android/w$a;
    ...
    :cond_10
    sget-object v3, Lio/flutter/embedding/android/w$a;->e:Lio/flutter/embedding/android/w$a;

    goto :goto_8

    :cond_11
    sget-object v3, Lio/flutter/embedding/android/w$a;->d:Lio/flutter/embedding/android/w$a;

    goto :goto_8

    :cond_12
    sget-object v3, Lio/flutter/embedding/android/w$a;->c:Lio/flutter/embedding/android/w$a;
    ...
    sget-object v0, Lio/flutter/embedding/android/w$a;->b:Lio/flutter/embedding/android/w$a;
...
.method private static synthetic k(Lio/flutter/embedding/android/b0$d$a;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, v1}, Lr6/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method private n(Lio/flutter/embedding/android/w;Lio/flutter/embedding/android/b0$d$a;)V
    ...
    :goto_0
    iget-object v0, p0, Lio/flutter/embedding/android/a0;->a:Le7/c;
...
.method private q(ZLjava/lang/Long;Ljava/lang/Long;J)V
    ...
    sget-object p4, Lio/flutter/embedding/android/w$b;->b:Lio/flutter/embedding/android/w$b;

    goto :goto_0

    :cond_0
    sget-object p4, Lio/flutter/embedding/android/w$b;->c:Lio/flutter/embedding/android/w$b;
    ...
    sget-object p5, Lio/flutter/embedding/android/w$a;->b:Lio/flutter/embedding/android/w$a;
