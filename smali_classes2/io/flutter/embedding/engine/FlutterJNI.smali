...
.field private deferredComponentManager:Lt6/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lr6/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ls6/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Ls6/f;->g(ILjava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lf7/b;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lf7/b;

    invoke-virtual {p1, v0}, Lf7/b;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lr6/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/g$g;Ljava/lang/Object;)V
    ...
    sget-object v0, Le7/r;->a:Le7/r;

    invoke-virtual {v0, p3}, Le7/r;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Ld7/p;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Ls6/f;->h(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onFirstFrame()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/engine/renderer/d;->e()V
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lt6/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lt6/a;->a(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Lt6/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lt6/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Lt6/a;->d(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lf7/b;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lf7/b;

    return-void
.end method

.method public setPlatformMessageHandler(Ls6/f;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ls6/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Ls7/c;->a(ZLjava/lang/Object;)V
