...
# instance fields
.field private final a:Lt7/a1$e;

.field final synthetic b:Lio/grpc/internal/e0;


# direct methods
.method constructor <init>(Lio/grpc/internal/e0;Lt7/a1$e;)V
    .locals 0
    ...
    iput-object p1, p0, Lio/grpc/internal/e0$e;->a:Lt7/a1$e;
...
.method public run()V
    ...
    invoke-static {v4}, Lio/grpc/internal/e0;->i(Lio/grpc/internal/e0;)Lt7/x;
    ...
    invoke-virtual {v5, v1}, Lt7/a1$g$a;->b(Ljava/util/List;)Lt7/a1$g$a;
    ...
    invoke-static {v0}, Lio/grpc/internal/e0$c;->c(Lio/grpc/internal/e0$c;)Lt7/j1;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-object v1, p0, Lio/grpc/internal/e0$e;->a:Lt7/a1$e;

    invoke-static {v0}, Lio/grpc/internal/e0$c;->c(Lio/grpc/internal/e0$c;)Lt7/j1;

    move-result-object v4

    invoke-virtual {v1, v4}, Lt7/a1$e;->b(Lt7/j1;)V
    :try_end_0
    ...
    invoke-static {v0}, Lio/grpc/internal/e0;->f(Lio/grpc/internal/e0;)Lt7/n1;
    ...
    :cond_5
    invoke-static {v0}, Lio/grpc/internal/e0$c;->e(Lio/grpc/internal/e0$c;)Lt7/a1$c;
    ...
    invoke-virtual {v5, v1}, Lt7/a1$g$a;->d(Lt7/a1$c;)Lt7/a1$g$a;

    :cond_6
    iget-object v1, v0, Lio/grpc/internal/e0$c;->d:Lt7/a;

    if-eqz v1, :cond_7

    invoke-virtual {v5, v1}, Lt7/a1$g$a;->c(Lt7/a;)Lt7/a1$g$a;

    :cond_7
    :goto_1
    iget-object v1, p0, Lio/grpc/internal/e0$e;->a:Lt7/a1$e;

    invoke-virtual {v5}, Lt7/a1$g$a;->a()Lt7/a1$g;

    move-result-object v4

    invoke-virtual {v1, v4}, Lt7/a1$e;->c(Lt7/a1$g;)V
    :try_end_1
    ...
    :try_start_2
    iget-object v4, p0, Lio/grpc/internal/e0$e;->a:Lt7/a1$e;

    sget-object v5, Lt7/j1;->u:Lt7/j1;
    ...
    invoke-virtual {v5, v1}, Lt7/j1;->p(Ljava/lang/Throwable;)Lt7/j1;

    move-result-object v1

    invoke-virtual {v4, v1}, Lt7/a1$e;->b(Lt7/j1;)V
    :try_end_2
    ...
    invoke-virtual {v0, v3}, Lt7/n1;->execute(Ljava/lang/Runnable;)V
