...
.field private n:Lio/grpc/internal/u0$c;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lio/grpc/internal/u0;->o:Z

    iput v0, p0, Lio/grpc/internal/u0;->s:I

    iput v0, p0, Lio/grpc/internal/u0;->t:I
...
.method private A()Z
    ...
    iget-object v0, p0, Lio/grpc/internal/u0;->m:Ljava/util/zip/Inflater;
    ...
    iget-object v2, p0, Lio/grpc/internal/u0;->m:Ljava/util/zip/Inflater;
    ...
    sget-object v0, Lio/grpc/internal/u0$c;->n:Lio/grpc/internal/u0$c;
...
.method private M([BII)I
    ...
    iget-object v1, p0, Lio/grpc/internal/u0;->m:Ljava/util/zip/Inflater;
    ...
    iget v0, p0, Lio/grpc/internal/u0;->s:I

    add-int/2addr v0, v1

    iput v0, p0, Lio/grpc/internal/u0;->s:I

    iget v0, p0, Lio/grpc/internal/u0;->t:I
    ...
    iget-object p1, p0, Lio/grpc/internal/u0;->m:Ljava/util/zip/Inflater;
    ...
    iput-wide p1, p0, Lio/grpc/internal/u0;->r:J

    sget-object p1, Lio/grpc/internal/u0$c;->p:Lio/grpc/internal/u0$c;

    :goto_1
    iput-object p1, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;
    ...
    sget-object p1, Lio/grpc/internal/u0$c;->o:Lio/grpc/internal/u0$c;
    :try_end_0
...
.method private S()Z
    ...
    iput-object v0, p0, Lio/grpc/internal/u0;->m:Ljava/util/zip/Inflater;
    ...
    iget-object v3, p0, Lio/grpc/internal/u0;->m:Ljava/util/zip/Inflater;
    ...
    :cond_1
    sget-object v0, Lio/grpc/internal/u0$c;->o:Lio/grpc/internal/u0$c;
...
.method private d0()Z
    ...
    iput v0, p0, Lio/grpc/internal/u0;->p:I
...
.method private f0()Z
    ...
    iget v0, p0, Lio/grpc/internal/u0;->p:I
...
.method private i0()Z
    ...
    :goto_0
    sget-object v0, Lio/grpc/internal/u0$c;->m:Lio/grpc/internal/u0$c;
...
.method static synthetic j(Lio/grpc/internal/u0;I)I
    .locals 1
...
.method static synthetic o(Lio/grpc/internal/u0;)[B
    .locals 0
...
.method private s0()Z
    ...
    iget v1, p0, Lio/grpc/internal/u0;->q:I
...
.method static synthetic t(Lio/grpc/internal/u0;)Lio/grpc/internal/w;
    .locals 0
...
.method private t0()Z
    ...
    iput v0, p0, Lio/grpc/internal/u0;->q:I
...
.method static synthetic u(Lio/grpc/internal/u0;)Ljava/util/zip/CRC32;
    .locals 0
...
.method static synthetic v(Lio/grpc/internal/u0;I)I
    .locals 1
...
.method private z0()Z
    ...
    iget-wide v0, p0, Lio/grpc/internal/u0;->r:J
...
.method C()I
    ...
    iput v1, p0, Lio/grpc/internal/u0;->s:I
...
.method E()I
    ...
    iput v1, p0, Lio/grpc/internal/u0;->t:I
...
.method J()Z
    ...
    iget-object v0, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;
...
.method O([BII)I
    ...
    iget-object v5, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;
    ...
    iget-object p3, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;
    ...
    :goto_1
    :pswitch_0
    invoke-direct {p0}, Lio/grpc/internal/u0;->z0()Z
    ...
    :pswitch_1
    invoke-direct {p0}, Lio/grpc/internal/u0;->A()Z
    ...
    invoke-direct {p0, p1, v2, v4}, Lio/grpc/internal/u0;->M([BII)I

    move-result v2

    add-int/2addr v3, v2

    iget-object v2, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;

    sget-object v4, Lio/grpc/internal/u0$c;->p:Lio/grpc/internal/u0$c;
    ...
    :pswitch_3
    invoke-direct {p0}, Lio/grpc/internal/u0;->S()Z
    ...
    :pswitch_4
    invoke-direct {p0}, Lio/grpc/internal/u0;->i0()Z
    ...
    :pswitch_5
    invoke-direct {p0}, Lio/grpc/internal/u0;->f0()Z
    ...
    :pswitch_6
    invoke-direct {p0}, Lio/grpc/internal/u0;->u0()Z
    ...
    :pswitch_7
    invoke-direct {p0}, Lio/grpc/internal/u0;->s0()Z
    ...
    :pswitch_8
    invoke-direct {p0}, Lio/grpc/internal/u0;->t0()Z
    ...
    :pswitch_9
    invoke-direct {p0}, Lio/grpc/internal/u0;->d0()Z
    ...
    iget-object p1, p0, Lio/grpc/internal/u0;->n:Lio/grpc/internal/u0$c;
    ...
    :cond_3
    :goto_2
    iput-boolean v1, p0, Lio/grpc/internal/u0;->u:Z
...
.method z(Lio/grpc/internal/x1;)V
    .locals 2
    ...
    iput-boolean p1, p0, Lio/grpc/internal/u0;->u:Z
