...
.field private transient reflected:Lu9/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Lu9/b;

    move-result-object v0

    invoke-interface {v0, p1}, Lu9/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lu9/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lu9/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lu9/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Lu9/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lu9/b;

    :cond_0
    return-object v0
.end method

.method protected abstract computeReflected()Lu9/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {v0}, Lu9/a;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Lu9/d;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/u;->c(Ljava/lang/Class;)Lu9/d;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lu9/b;->getParameters()Ljava/util/List;
...
.method protected getReflected()Lu9/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Lu9/b;
...
.method public getReturnType()Lu9/i;
    .locals 1
    ...
    invoke-interface {v0}, Lu9/b;->getReturnType()Lu9/i;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lu9/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lu9/j;
    .locals 1
    ...
    invoke-interface {v0}, Lu9/b;->getVisibility()Lu9/j;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Lu9/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Lu9/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Lu9/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Lu9/b;->isSuspend()Z
