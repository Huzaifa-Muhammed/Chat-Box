...
.method constructor <init>(Ld7/k;)V
    ...
    iput-object p1, p0, Ld7/k$a;->a:Ld7/k;
...
.method public onMethodCall(Le7/j;Le7/k$d;)V
    ...
    iget-object v1, p0, Ld7/k$a;->a:Ld7/k;

    invoke-static {v1}, Ld7/k;->a(Ld7/k;)Ld7/k$h;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->j(Ljava/lang/String;)V
    ...
    :pswitch_1
    iget-object p1, p0, Ld7/k$a;->a:Ld7/k;

    invoke-static {p1}, Ld7/k;->a(Ld7/k;)Ld7/k$h;

    move-result-object p1

    invoke-interface {p1}, Ld7/k$h;->r()Z
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->i(Ljava/lang/String;)V
    ...
    :try_start_2
    invoke-static {p1}, Ld7/k$e;->h(Ljava/lang/String;)Ld7/k$e;
    ...
    invoke-interface {p2, v0, p1, v3}, Le7/k$d;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    :cond_3
    move-object p1, v3

    :goto_2
    iget-object v2, p0, Ld7/k$a;->a:Ld7/k;

    invoke-static {v2}, Ld7/k;->a(Ld7/k;)Ld7/k$h;

    move-result-object v2

    invoke-interface {v2, p1}, Ld7/k$h;->l(Ld7/k$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p1}, Ld7/k$h;->b()V
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->f(Z)V
    :try_end_3
    ...
    invoke-static {v1, p1}, Ld7/k;->f(Ld7/k;Lorg/json/JSONObject;)Ld7/k$j;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->o(Ld7/k$j;)V
    ...
    invoke-interface {p1}, Ld7/k$h;->n()V
    ...
    invoke-interface {p1}, Ld7/k$h;->m()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Ld7/k;->e(Ld7/k;Ljava/lang/String;)Ld7/k$k;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->q(Ld7/k$k;)V
    ...
    invoke-static {v1, p1}, Ld7/k;->d(Ld7/k;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->h(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Ld7/k;->c(Ld7/k;Lorg/json/JSONObject;)Ld7/k$c;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->g(Ld7/k$c;)V
    ...
    invoke-static {v1, p1}, Ld7/k;->b(Ld7/k;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->p(I)V
    ...
    invoke-static {p1}, Ld7/k$g;->h(Ljava/lang/String;)Ld7/k$g;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->k(Ld7/k$g;)V
    ...
    invoke-static {p1}, Ld7/k$i;->h(Ljava/lang/String;)Ld7/k$i;
    ...
    invoke-interface {v1, p1}, Ld7/k$h;->s(Ld7/k$i;)V
