...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1}, Lw2/q;->c(Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Landroid/content/Intent;
...
.method public static d(Landroid/content/Intent;)Lv2/b;
    .locals 3
    ...
    invoke-direct {p0, v0, v1}, Lv2/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-direct {v0, p0, v1}, Lv2/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
...
.method public static e(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;Z)Lcom/google/android/gms/common/api/g;
    ...
    invoke-virtual {v0, v3, v2}, Lc3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lw2/r;->c(Landroid/content/Context;)Lw2/r;

    move-result-object v2

    invoke-virtual {v2}, Lw2/r;->b()Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    ...
    :cond_1
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->s()Landroid/accounts/Account;

    move-result-object v4

    invoke-virtual {p2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->s()Landroid/accounts/Account;
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->B()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lw2/r;->a()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;

    move-result-object v2

    if-eqz v2, :cond_0

    invoke-virtual {v2}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->F()Z
    ...
    invoke-direct {v4, v2, v5}, Lv2/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, p2, p1}, Lc3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v3, p2}, Lv2/b;-><init>(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, v1, p3}, Lc3/a;->a(Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance p3, Lw2/k;

    invoke-direct {p3, p0, p1, p2}, Lw2/k;-><init>(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)V
...
.method public static f(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/h;
    ...
    invoke-virtual {v0}, Lw2/c;->e()Ljava/lang/String;

    move-result-object v0

    invoke-static {p1}, Lw2/q;->h(Landroid/content/Context;)V

    if-eqz p2, :cond_0

    invoke-static {v0}, Lw2/f;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/h;
    ...
    invoke-direct {p1, p0}, Lw2/o;-><init>(Lcom/google/android/gms/common/api/f;)V
...
.method public static g(Lcom/google/android/gms/common/api/f;Landroid/content/Context;Z)Lcom/google/android/gms/common/api/h;
    ...
    invoke-direct {p1, p0}, Lw2/m;-><init>(Lcom/google/android/gms/common/api/f;)V
...
.method private static h(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lw2/r;->c(Landroid/content/Context;)Lw2/r;

    move-result-object p0

    invoke-virtual {p0}, Lw2/r;->d()V
