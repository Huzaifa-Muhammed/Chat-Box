...
.method private d(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-static {p1}, Lh1/w;->a(Landroid/location/LocationManager;)Z
    ...
    :cond_1
    invoke-static {p1}, Lh1/x;->e(Landroid/content/Context;)Z
...
# virtual methods
.method a(ILandroid/content/Context;Lh1/x$a;Lh1/b;)V
    .locals 3
    ...
    invoke-interface {p4, p1, p2}, Lh1/b;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2}, Lh1/x;->c(Landroid/content/Context;)Z

    move-result p1

    invoke-interface {p3, p1}, Lh1/x$a;->a(I)V
    ...
    invoke-interface {p3, v2}, Lh1/x$a;->a(I)V
    ...
    :cond_4
    invoke-direct {p0, p1}, Lh1/x;->b(Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    :cond_6
    invoke-interface {p3, v1}, Lh1/x$a;->a(I)V
    ...
    :cond_b
    :goto_2
    invoke-direct {p0, p2}, Lh1/x;->d(Landroid/content/Context;)Z
