...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lz2/j;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lz2/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, Lz2/f;->h(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, p0, p1, v1}, Lz2/f;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1}, Lz2/g;-><init>(I)V
    ...
    invoke-direct {v0, p1, v1, p0}, Lz2/h;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static c(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lz2/b;->D(I)Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p0}, Lh3/d;->a(Landroid/content/Context;)Lh3/c;
    ...
    invoke-virtual {v0, v3, v4}, Lh3/c;->d(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {p0}, Lz2/k;->a(Landroid/content/Context;)Lz2/k;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Lz2/k;->d(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lz2/k;->d(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lz2/j;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lz2/j;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lz2/j;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Lf3/g;->b()Z
...
.method public static g(Landroid/content/Context;I)I
    ...
    sget-object v1, Lz2/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Lf3/g;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lf3/g;->f(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Lz2/k;->d(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Lz2/k;->d(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lf3/q;->a(I)I

    move-result p0

    invoke-static {p1}, Lf3/q;->a(I)I
...
.method public static h(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lz2/j;->k(Landroid/content/Context;Ljava/lang/String;)Z
...
.method static k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lz2/j;->i(Landroid/content/Context;)Z
