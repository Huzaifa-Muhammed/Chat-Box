...
.method static constructor <clinit>()V
    ...
    sput-object v0, La5/h0;->a:Ljava/util/Random;

    new-instance v0, La5/c0;

    invoke-direct {v0}, La5/c0;-><init>()V

    sput-object v0, La5/h0;->b:Lcom/google/android/gms/tasks/Continuation;
...
.method public static A(Lcom/google/protobuf/i;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lcom/google/protobuf/i;->k(I)B
...
.method public static C()Lcom/google/android/gms/tasks/Continuation;
    ...
    sget-object v0, La5/h0;->b:Lcom/google/android/gms/tasks/Continuation;
...
.method public static synthetic a(Ljava/lang/RuntimeException;)V
    ...
    invoke-static {p0}, La5/h0;->v(Ljava/lang/RuntimeException;)V
...
.method public static synthetic b(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
    ...
    invoke-static {p0, p1}, La5/h0;->w(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
...
.method public static synthetic c(Ljava/util/Comparator;Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
    ...
    invoke-static {p0, p1, p2}, La5/h0;->x(Ljava/util/Comparator;Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
...
.method public static synthetic d(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    ...
    invoke-static {p0}, La5/h0;->y(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
...
.method public static j(Lcom/google/protobuf/i;Lcom/google/protobuf/i;)I
    ...
    invoke-virtual {p0, v1}, Lcom/google/protobuf/i;->k(I)B

    move-result v2

    and-int/lit16 v2, v2, 0xff

    invoke-virtual {p1, v1}, Lcom/google/protobuf/i;->k(I)B
...
.method public static k(DD)I
    ...
    invoke-static {p0, p1, p2, p3}, Lr3/a;->c(DD)I
...
.method public static m(JJ)I
    ...
    invoke-static {p0, p1, p2, p3}, Lr3/a;->a(JJ)I
...
.method public static n(DJ)I
    ...
    invoke-static {p0, p1, p2, p3}, Lr3/a;->b(DJ)I
...
.method private static o(Ljava/lang/Exception;)Ljava/lang/Exception;
    ...
    invoke-virtual {p0}, Lt7/k1;->a()Lt7/j1;

    move-result-object p0

    :goto_0
    invoke-static {p0}, La5/h0;->t(Lt7/j1;)Lcom/google/firebase/firestore/z;
    ...
    :cond_0
    instance-of v0, p0, Lt7/l1;

    if-eqz v0, :cond_1

    check-cast p0, Lt7/l1;

    invoke-virtual {p0}, Lt7/l1;->a()Lt7/j1;
...
.method public static p(Ljava/lang/RuntimeException;)V
    ...
    invoke-direct {v1, p0}, La5/d0;-><init>(Ljava/lang/RuntimeException;)V
...
.method public static q(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Comparator;La5/n;La5/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1, p0, p2, p3, p4}, La5/h0;->r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;La5/n;La5/n;)V

    return-void
.end method

.method private static r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;La5/n;La5/n;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_0
    invoke-static {p0}, La5/h0;->e(Ljava/util/Iterator;)Ljava/lang/Object;

    move-result-object v0

    :goto_0
    invoke-static {p1}, La5/h0;->e(Ljava/util/Iterator;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v1}, La5/n;->accept(Ljava/lang/Object;)V
    ...
    invoke-interface {p4, v0}, La5/n;->accept(Ljava/lang/Object;)V
...
.method public static s(Ljava/util/SortedSet;Ljava/util/SortedSet;La5/n;La5/n;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    invoke-direct {p0}, La5/f0;-><init>()V

    :goto_0
    invoke-static {v0, p1, p0, p2, p3}, La5/h0;->r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;La5/n;La5/n;)V

    return-void
.end method

.method public static t(Lt7/j1;)Lcom/google/firebase/firestore/z;
    .locals 3

    invoke-virtual {p0}, Lt7/j1;->c()Lt7/k1;
...
.method public static u(Ljava/util/Map;ILjava/util/Comparator;)Ljava/util/Map;
    ...
    new-instance p0, La5/g0;

    invoke-direct {p0, p2}, La5/g0;-><init>(Ljava/util/Comparator;)V
...
.method private static synthetic y(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    ...
    invoke-static {p0}, La5/h0;->o(Ljava/lang/Exception;)Ljava/lang/Exception;
