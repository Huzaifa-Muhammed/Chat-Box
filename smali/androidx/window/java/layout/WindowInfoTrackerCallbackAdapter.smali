...
.method private final addListener(Ljava/util/concurrent/Executor;Lu/a;Lba/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Ly9/p1;->a(Ljava/util/concurrent/Executor;)Ly9/i0;

    move-result-object p1

    invoke-static {p1}, Ly9/m0;->a(Lg9/g;)Ly9/l0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lba/b;Lu/a;Lg9/d;)V
...
.method private final removeListener(Lu/a;)V
    ...
    invoke-static {v1, v3, v2, v3}, Ly9/x1$a;->a(Ly9/x1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
...
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Lu/a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/window/layout/WindowInfoTracker;->windowLayoutInfo(Landroid/app/Activity;)Lba/b;

    move-result-object p1

    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Lu/a;Lba/b;)V
...
.method public windowLayoutInfo(Landroid/app/Activity;)Lba/b;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
