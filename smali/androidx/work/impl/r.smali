...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Landroidx/work/impl/r;->d:Lf1/c;
    ...
    iput-object p1, p0, Landroidx/work/impl/r;->m:Ljava/util/Map;
    ...
    iput-object p1, p0, Landroidx/work/impl/r;->n:Ljava/util/Map;

    return-void
.end method

.method public static synthetic e(Landroidx/work/impl/r;Ld1/m;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/work/impl/r;->l(Ld1/m;Z)V

    return-void
.end method

.method public static synthetic f(Landroidx/work/impl/r;Ljava/util/ArrayList;Ljava/lang/String;)Ld1/v;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/work/impl/r;->m(Ljava/util/ArrayList;Ljava/lang/String;)Ld1/v;
...
.method private synthetic l(Ld1/m;Z)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/r;->b(Ld1/m;Z)V

    return-void
.end method

.method private synthetic m(Ljava/util/ArrayList;Ljava/lang/String;)Ld1/v;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/r;->e:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->J()Ld1/a0;

    move-result-object v0

    invoke-interface {v0, p2}, Ld1/a0;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p1}, Landroidx/work/impl/WorkDatabase;->I()Ld1/w;

    move-result-object p1

    invoke-interface {p1, p2}, Ld1/w;->n(Ljava/lang/String;)Ld1/v;
...
.method private o(Ld1/m;Z)V
    .locals 2

    iget-object v0, p0, Landroidx/work/impl/r;->d:Lf1/c;
    ...
    invoke-direct {v1, p0, p1, p2}, Landroidx/work/impl/q;-><init>(Landroidx/work/impl/r;Ld1/m;Z)V
...
.method public a(Ljava/lang/String;Landroidx/work/g;)V
    ...
    iget-object v1, p0, Landroidx/work/impl/r;->m:Ljava/util/Map;
    ...
    invoke-static {v2, v3}, Le1/w;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/h0;->d()Ld1/m;

    move-result-object v1

    invoke-static {p1, v1, p2}, Landroidx/work/impl/foreground/b;->e(Landroid/content/Context;Ld1/m;Landroidx/work/g;)Landroid/content/Intent;
...
.method public b(Ld1/m;Z)V
    ...
    invoke-virtual {p1, v1}, Ld1/m;->equals(Ljava/lang/Object;)Z
    ...
    invoke-interface {v2, p1, p2}, Landroidx/work/impl/e;->b(Ld1/m;Z)V
...
.method public h(Ljava/lang/String;)Ld1/v;
    .locals 2
    ...
    invoke-virtual {v1}, Landroidx/work/impl/h0;->e()Ld1/v;
...
.method public q(Landroidx/work/impl/v;Landroidx/work/WorkerParameters$a;)Z
    ...
    invoke-virtual {p1}, Landroidx/work/impl/v;->a()Ld1/m;

    move-result-object v0

    invoke-virtual {v0}, Ld1/m;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lp0/k0;->z(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, v2}, Landroidx/work/impl/r;->o(Ld1/m;Z)V
    ...
    iget-object p2, p0, Landroidx/work/impl/r;->n:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/v;->a()Ld1/m;

    move-result-object v1

    invoke-virtual {v1}, Ld1/m;->a()I

    move-result v1

    invoke-virtual {v0}, Ld1/m;->a()I
    ...
    iget-object v5, p0, Landroidx/work/impl/r;->d:Lf1/c;
    ...
    invoke-direct/range {v2 .. v9}, Landroidx/work/impl/h0$c;-><init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/foreground/a;Landroidx/work/impl/WorkDatabase;Ld1/v;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Landroidx/work/impl/h0;->c()Lcom/google/common/util/concurrent/e;
    ...
    invoke-direct {v3, p0, v4, v2}, Landroidx/work/impl/r$a;-><init>(Landroidx/work/impl/e;Ld1/m;Lcom/google/common/util/concurrent/e;)V

    iget-object v4, p0, Landroidx/work/impl/r;->d:Lf1/c;

    invoke-interface {v4}, Lf1/c;->a()Ljava/util/concurrent/Executor;

    move-result-object v4

    invoke-interface {v2, v3, v4}, Lcom/google/common/util/concurrent/e;->d(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    iget-object v2, p0, Landroidx/work/impl/r;->m:Ljava/util/Map;
    ...
    iget-object p1, p0, Landroidx/work/impl/r;->n:Ljava/util/Map;
    ...
    iget-object p1, p0, Landroidx/work/impl/r;->d:Lf1/c;

    invoke-interface {p1}, Lf1/c;->b()Lf1/a;
...
.method public r(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, Landroidx/work/impl/r;->n:Ljava/util/Map;
...
.method public t(Landroidx/work/impl/v;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/r;->n:Ljava/util/Map;
...
.method public u(Landroidx/work/impl/v;)Z
    ...
    :cond_0
    iget-object v4, p0, Landroidx/work/impl/r;->n:Ljava/util/Map;
