...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;)V
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/work/impl/e0;-><init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Z)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/WorkDatabase;)V
    .locals 9
    ...
    invoke-direct {v1, v0, p3}, Lc1/o;-><init>(Landroid/content/Context;Lf1/c;)V

    iput-object v1, p0, Landroidx/work/impl/e0;->j:Lc1/o;

    invoke-virtual {p0, v0, p2, v1}, Landroidx/work/impl/e0;->f(Landroid/content/Context;Landroidx/work/b;Lc1/o;)Ljava/util/List;
    ...
    invoke-direct/range {v2 .. v7}, Landroidx/work/impl/r;-><init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V

    move-object v2, p0

    invoke-direct/range {v2 .. v8}, Landroidx/work/impl/e0;->q(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/r;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Z)V
    .locals 2
    ...
    invoke-interface {p3}, Lf1/c;->b()Lf1/a;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/work/impl/e0;-><init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/WorkDatabase;)V
...
.method public static d(Landroid/content/Context;Landroidx/work/b;)V
    ...
    invoke-direct {v2, v3}, Lf1/d;-><init>(Ljava/util/concurrent/Executor;)V

    invoke-direct {v1, p0, p1, v2}, Landroidx/work/impl/e0;-><init>(Landroid/content/Context;Landroidx/work/b;Lf1/c;)V
...
.method public static j(Landroid/content/Context;)Landroidx/work/impl/e0;
    ...
    invoke-static {p0, v1}, Landroidx/work/impl/e0;->d(Landroid/content/Context;Landroidx/work/b;)V
...
.method private q(Landroid/content/Context;Landroidx/work/b;Lf1/c;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/r;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Landroidx/work/impl/e0;->d:Lf1/c;
    ...
    invoke-direct {p2, p4}, Le1/q;-><init>(Landroidx/work/impl/WorkDatabase;)V

    iput-object p2, p0, Landroidx/work/impl/e0;->g:Le1/q;
    ...
    :cond_1
    :goto_0
    iget-object p2, p0, Landroidx/work/impl/e0;->d:Lf1/c;
    ...
    invoke-interface {p2, p3}, Lf1/c;->c(Ljava/lang/Runnable;)V
...
.method public e(Ljava/util/UUID;)Landroidx/work/p;
    .locals 1

    invoke-static {p1, p0}, Le1/c;->b(Ljava/util/UUID;Landroidx/work/impl/e0;)Le1/c;

    move-result-object p1

    iget-object v0, p0, Landroidx/work/impl/e0;->d:Lf1/c;

    invoke-interface {v0, p1}, Lf1/c;->c(Ljava/lang/Runnable;)V

    invoke-virtual {p1}, Le1/c;->d()Landroidx/work/p;
...
.method public f(Landroid/content/Context;Landroidx/work/b;Lc1/o;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3, p0}, Lz0/b;-><init>(Landroid/content/Context;Landroidx/work/b;Lc1/o;Landroidx/work/impl/e0;)V
...
.method public k()Le1/q;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/e0;->g:Le1/q;
...
.method public n()Lc1/o;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/e0;->j:Lc1/o;
...
.method public s()V
    ...
    invoke-interface {v0}, Ld1/w;->u()I

    invoke-virtual {p0}, Landroidx/work/impl/e0;->h()Landroidx/work/b;
...
.method public v(Landroidx/work/impl/v;Landroidx/work/WorkerParameters$a;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Le1/t;-><init>(Landroidx/work/impl/e0;Landroidx/work/impl/v;Landroidx/work/WorkerParameters$a;)V
...
.method public w(Ld1/m;)V
    ...
    invoke-direct {v2, p1}, Landroidx/work/impl/v;-><init>(Ld1/m;)V

    const/4 p1, 0x1

    invoke-direct {v1, p0, v2, p1}, Le1/u;-><init>(Landroidx/work/impl/e0;Landroidx/work/impl/v;Z)V
...
.method public x(Landroidx/work/impl/v;)V
    ...
    invoke-direct {v1, p0, p1, v2}, Le1/u;-><init>(Landroidx/work/impl/e0;Landroidx/work/impl/v;Z)V
