...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/e0;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/e0;

    invoke-virtual {p2}, Landroidx/work/impl/e0;->k()Le1/q;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Le1/q;
...
.method public a()Z
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/e0;
    ...
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->I()Ld1/w;

    move-result-object v3

    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->H()Ld1/r;

    move-result-object v4

    invoke-virtual {v2}, Lp0/k0;->e()V

    :try_start_0
    invoke-interface {v3}, Ld1/w;->j()Ljava/util/List;
    ...
    sget-object v9, Landroidx/work/v;->a:Landroidx/work/v;

    iget-object v10, v8, Ld1/v;->a:Ljava/lang/String;

    invoke-interface {v3, v9, v10}, Ld1/w;->g(Landroidx/work/v;Ljava/lang/String;)I

    iget-object v8, v8, Ld1/v;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v3, v8, v9, v10}, Ld1/w;->c(Ljava/lang/String;J)I

    goto :goto_2

    :cond_2
    invoke-interface {v4}, Ld1/r;->c()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/e0;

    invoke-virtual {v0}, Landroidx/work/impl/e0;->s()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/e0;

    invoke-virtual {v0}, Landroidx/work/impl/e0;->k()Le1/q;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Le1/q;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Le1/q;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Le1/q;->d(J)V
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Landroidx/work/impl/e0;
...
.method public e()Z
    ...
    invoke-static {v0, v2, v4, v4}, Le1/f;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Le1/q;

    invoke-virtual {v2}, Le1/q;->a()J
    ...
    invoke-virtual {v2, v3, v4, v0}, Landroidx/work/m;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-virtual {v0}, Landroidx/work/b;->e()Lu/a;
    ...
    :goto_2
    invoke-interface {v0, v2}, Lu/a;->accept(Ljava/lang/Object;)V
