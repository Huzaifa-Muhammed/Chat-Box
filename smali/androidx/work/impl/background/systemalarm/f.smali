...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/g;Landroidx/work/impl/v;)V
    ...
    invoke-virtual {p4}, Landroidx/work/impl/v;->a()Ld1/m;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/f;->c:Ld1/m;
    ...
    invoke-virtual {p1}, Landroidx/work/impl/e0;->n()Lc1/o;

    move-result-object p1

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/g;->f()Lf1/c;

    move-result-object p2

    invoke-interface {p2}, Lf1/c;->b()Lf1/a;

    move-result-object p2

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/f;->n:Ljava/util/concurrent/Executor;

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/g;->f()Lf1/c;

    move-result-object p2

    invoke-interface {p2}, Lf1/c;->a()Ljava/util/concurrent/Executor;
    ...
    invoke-direct {p2, p1, p0}, La1/e;-><init>(Lc1/o;La1/c;)V

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/f;->e:La1/e;

    const/4 p1, 0x0

    iput-boolean p1, p0, Landroidx/work/impl/background/systemalarm/f;->q:Z

    iput p1, p0, Landroidx/work/impl/background/systemalarm/f;->m:I
...
.method private e()V
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/f;->e:La1/e;

    invoke-virtual {v1}, La1/e;->reset()V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/f;->d:Landroidx/work/impl/background/systemalarm/g;

    invoke-virtual {v1}, Landroidx/work/impl/background/systemalarm/g;->h()Le1/c0;

    move-result-object v1

    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/f;->c:Ld1/m;

    invoke-virtual {v1, v2}, Le1/c0;->b(Ld1/m;)V
    ...
    iget-object v4, p0, Landroidx/work/impl/background/systemalarm/f;->c:Ld1/m;
...
.method private i()V
    ...
    iget v0, p0, Landroidx/work/impl/background/systemalarm/f;->m:I

    if-nez v0, :cond_1

    const/4 v0, 0x1

    iput v0, p0, Landroidx/work/impl/background/systemalarm/f;->m:I
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/f;->c:Ld1/m;
    ...
    invoke-virtual {v0}, Landroidx/work/impl/background/systemalarm/g;->h()Le1/c0;

    move-result-object v0

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/f;->c:Ld1/m;

    const-wide/32 v2, 0x927c0

    invoke-virtual {v0, v1, v2, v3, p0}, Le1/c0;->a(Ld1/m;JLe1/c0$a;)V
...
.method private j()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/f;->c:Ld1/m;

    invoke-virtual {v0}, Ld1/m;->b()Ljava/lang/String;

    move-result-object v0

    iget v1, p0, Landroidx/work/impl/background/systemalarm/f;->m:I

    const/4 v2, 0x2

    if-ge v1, v2, :cond_1

    iput v2, p0, Landroidx/work/impl/background/systemalarm/f;->m:I
    ...
    invoke-static {v1, v3}, Landroidx/work/impl/background/systemalarm/b;->g(Landroid/content/Context;Ld1/m;)Landroid/content/Intent;
    ...
    invoke-virtual {v3}, Ld1/m;->b()Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Landroidx/work/impl/background/systemalarm/b;->f(Landroid/content/Context;Ld1/m;)Landroid/content/Intent;
...
.method public a(Ljava/util/List;)V
    ...
    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/f;->n:Ljava/util/concurrent/Executor;
...
.method g()V
    ...
    invoke-static {v1, v2}, Le1/w;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/f;->n:Ljava/util/concurrent/Executor;
    ...
    :cond_1
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/f;->e:La1/e;

    invoke-static {v1}, Ljava/util/Collections;->singletonList(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, v1}, La1/e;->a(Ljava/lang/Iterable;)V
...
.method h(Z)V
    ...
    invoke-static {p1, v0}, Landroidx/work/impl/background/systemalarm/b;->f(Landroid/content/Context;Ld1/m;)Landroid/content/Intent;
