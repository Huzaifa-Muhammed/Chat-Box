...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/e0;Landroid/app/job/JobScheduler;Landroidx/work/impl/background/systemjob/j;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-static {v0, v1}, Landroidx/work/impl/background/systemjob/k;->b(Landroid/app/job/JobScheduler;I)V
...
.method private static f(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0}, Landroidx/work/impl/background/systemjob/k;->h(Landroid/app/job/JobInfo;)Ld1/m;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Ld1/m;->b()Ljava/lang/String;
...
.method private static h(Landroid/app/job/JobInfo;)Ld1/m;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Ld1/m;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public static i(Landroid/content/Context;Landroidx/work/impl/e0;)Z
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->F()Ld1/j;

    move-result-object v1

    invoke-interface {v1}, Ld1/j;->a()Ljava/util/List;
    ...
    invoke-static {v3}, Landroidx/work/impl/background/systemjob/k;->h(Landroid/app/job/JobInfo;)Ld1/m;

    move-result-object v5

    if-eqz v5, :cond_1

    invoke-virtual {v5}, Ld1/m;->b()Ljava/lang/String;
    ...
    invoke-static {v0, v3}, Landroidx/work/impl/background/systemjob/k;->b(Landroid/app/job/JobScheduler;I)V
    ...
    :try_start_0
    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->I()Ld1/w;
    ...
    invoke-interface {p1, v1, v3, v4}, Ld1/w;->c(Ljava/lang/String;J)I
...
.method public d(Ljava/lang/String;)V
    ...
    invoke-static {v2, v1}, Landroidx/work/impl/background/systemjob/k;->b(Landroid/app/job/JobScheduler;I)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {v0}, Landroidx/work/impl/e0;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object v0

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->F()Ld1/j;

    move-result-object v0

    invoke-interface {v0, p1}, Ld1/j;->f(Ljava/lang/String;)V

    :cond_1
    return-void
.end method

.method public varargs e([Ld1/v;)V
    .locals 10
    ...
    invoke-direct {v1, v0}, Le1/i;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    iget-object v7, v5, Ld1/v;->a:Ljava/lang/String;

    invoke-interface {v6, v7}, Ld1/w;->n(Ljava/lang/String;)Ld1/v;
    ...
    iget-object v5, v5, Ld1/v;->a:Ljava/lang/String;
    ...
    invoke-virtual {v6, v8, v5}, Landroidx/work/m;->k(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_2
    iget-object v6, v6, Ld1/v;->b:Landroidx/work/v;

    sget-object v8, Landroidx/work/v;->a:Landroidx/work/v;
    ...
    :cond_2
    invoke-static {v5}, Ld1/y;->a(Ld1/v;)Ld1/m;
    ...
    invoke-interface {v7, v6}, Ld1/j;->b(Ld1/m;)Ld1/i;

    move-result-object v7

    if-eqz v7, :cond_3

    iget v8, v7, Ld1/i;->c:I

    goto :goto_2

    :cond_3
    iget-object v8, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {v8}, Landroidx/work/impl/e0;->h()Landroidx/work/b;
    ...
    iget-object v9, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {v9}, Landroidx/work/impl/e0;->h()Landroidx/work/b;
    ...
    invoke-virtual {v1, v8, v9}, Le1/i;->e(II)I
    ...
    invoke-static {v6, v8}, Ld1/l;->a(Ld1/m;I)Ld1/i;

    move-result-object v6

    iget-object v7, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {v7}, Landroidx/work/impl/e0;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object v7

    invoke-virtual {v7}, Landroidx/work/impl/WorkDatabase;->F()Ld1/j;

    move-result-object v7

    invoke-interface {v7, v6}, Ld1/j;->d(Ld1/i;)V

    :cond_4
    invoke-virtual {p0, v5, v8}, Landroidx/work/impl/background/systemjob/k;->j(Ld1/v;I)V
    ...
    iget-object v9, v5, Ld1/v;->a:Ljava/lang/String;
    ...
    :cond_6
    iget-object v6, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {v6}, Landroidx/work/impl/e0;->h()Landroidx/work/b;
    ...
    invoke-virtual {v7}, Landroidx/work/impl/e0;->h()Landroidx/work/b;
    ...
    invoke-virtual {v1, v6, v7}, Le1/i;->e(II)I

    move-result v6

    :goto_3
    invoke-virtual {p0, v5, v6}, Landroidx/work/impl/background/systemjob/k;->j(Ld1/v;I)V
    :try_end_2
...
.method public j(Ld1/v;I)V
    .locals 6

    iget-object v0, p0, Landroidx/work/impl/background/systemjob/k;->d:Landroidx/work/impl/background/systemjob/j;

    invoke-virtual {v0, p1, p2}, Landroidx/work/impl/background/systemjob/j;->a(Ld1/v;I)Landroid/app/job/JobInfo;
    ...
    iget-object v4, p1, Ld1/v;->a:Ljava/lang/String;
    ...
    iget-object v5, p1, Ld1/v;->a:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v4}, Landroidx/work/m;->k(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v0, p1, Ld1/v;->q:Z

    if-eqz v0, :cond_1

    iget-object v0, p1, Ld1/v;->r:Landroidx/work/q;

    sget-object v4, Landroidx/work/q;->a:Landroidx/work/q;

    if-ne v0, v4, :cond_1

    iput-boolean v3, p1, Ld1/v;->q:Z
    ...
    invoke-virtual {v4, v2, v0}, Landroidx/work/m;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/background/systemjob/k;->j(Ld1/v;I)V
    :try_end_0
    ...
    invoke-virtual {v0, v1, p1, p2}, Landroidx/work/m;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object p2, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {p2}, Landroidx/work/impl/e0;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object p2

    invoke-virtual {p2}, Landroidx/work/impl/WorkDatabase;->I()Ld1/w;

    move-result-object p2

    invoke-interface {p2}, Ld1/w;->h()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;
    ...
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/k;->c:Landroidx/work/impl/e0;

    invoke-virtual {p1}, Landroidx/work/impl/e0;->h()Landroidx/work/b;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/work/b;->l()Lu/a;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-interface {p1, v0}, Lu/a;->accept(Ljava/lang/Object;)V
