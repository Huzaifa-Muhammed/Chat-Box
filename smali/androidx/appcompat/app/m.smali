...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/q0;->M(Landroid/view/View;Z)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/q0;->N(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p2, p3}, Landroidx/core/view/q0;->U(Landroid/view/View;Z)V
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroidx/core/view/q0;->w(Landroid/view/View;)Z
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/m;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/j1;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/m;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n0;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/m;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/t0;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/m;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r0;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/m;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d1;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/m;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/o0;
