...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Lv/l;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lv/l;->a()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p2}, Lv/h;->c0(Landroid/view/accessibility/AccessibilityNodeInfo;)Lv/h;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/view/q0;->A(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lv/h;->Y(Z)V

    invoke-static {p1}, Landroidx/core/view/q0;->x(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lv/h;->W(Z)V

    invoke-static {p1}, Landroidx/core/view/q0;->l(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lv/h;->X(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/q0;->t(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lv/h;->a0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Lv/h;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Lv/h;->c(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    check-cast v1, Lv/h$a;

    invoke-virtual {v0, v1}, Lv/h;->a(Lv/h$a;)V
