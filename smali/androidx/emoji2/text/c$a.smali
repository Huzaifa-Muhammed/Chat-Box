...
.method private a(Landroid/content/Context;Lt/g;)Landroidx/emoji2/text/e$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/j;-><init>(Landroid/content/Context;Lt/g;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lt/g;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, v2, p2}, Lt/g;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/e$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/c$a;->h(Landroid/content/Context;)Lt/g;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/c$a;->a(Landroid/content/Context;Lt/g;)Landroidx/emoji2/text/e$c;
...
.method h(Landroid/content/Context;)Lt/g;
    .locals 2
    ...
    invoke-static {p1, v0}, Lu/d;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/c$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lt/g;
