...
.method public constructor <init>(Landroidx/work/impl/x;)V
    ...
    invoke-direct {p0, p1, v0}, Le1/d;-><init>(Landroidx/work/impl/x;Landroidx/work/impl/o;)V
...
.method public constructor <init>(Landroidx/work/impl/x;Landroidx/work/impl/o;)V
    ...
    iput-object p1, p0, Le1/d;->a:Landroidx/work/impl/x;

    iput-object p2, p0, Le1/d;->b:Landroidx/work/impl/o;
...
.method private static b(Landroidx/work/impl/x;)Z
    ...
    invoke-static {v1, v2, v0, v3, v4}, Le1/d;->c(Landroidx/work/impl/e0;Ljava/util/List;[Ljava/lang/String;Ljava/lang/String;Landroidx/work/f;)Z
...
.method private static c(Landroidx/work/impl/e0;Ljava/util/List;[Ljava/lang/String;Ljava/lang/String;Landroidx/work/f;)Z
    .locals 18
    ...
    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->I()Ld1/w;

    move-result-object v15

    invoke-interface {v15, v14}, Ld1/w;->n(Ljava/lang/String;)Ld1/v;
    ...
    sget-object v1, Le1/d;->c:Ljava/lang/String;
    ...
    :cond_1
    iget-object v14, v15, Ld1/v;->b:Landroidx/work/v;
    ...
    invoke-interface {v10, v1}, Ld1/w;->d(Ljava/lang/String;)Ljava/util/List;
    ...
    check-cast v14, Ld1/v$b;

    iget-object v14, v14, Ld1/v$b;->b:Landroidx/work/v;

    sget-object v15, Landroidx/work/v;->a:Landroidx/work/v;

    if-eq v14, v15, :cond_a

    sget-object v15, Landroidx/work/v;->b:Landroidx/work/v;
    ...
    invoke-static {v1, v14, v7}, Le1/c;->c(Ljava/lang/String;Landroidx/work/impl/e0;Z)Le1/c;

    move-result-object v2

    invoke-virtual {v2}, Le1/c;->run()V
    ...
    check-cast v15, Ld1/v$b;

    iget-object v15, v15, Ld1/v$b;->a:Ljava/lang/String;

    invoke-interface {v2, v15}, Ld1/w;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->D()Ld1/b;
    ...
    check-cast v6, Ld1/v$b;

    iget-object v7, v6, Ld1/v$b;->a:Ljava/lang/String;

    invoke-interface {v8, v7}, Ld1/b;->d(Ljava/lang/String;)Z

    move-result v7

    if-nez v7, :cond_10

    iget-object v7, v6, Ld1/v$b;->b:Landroidx/work/v;

    move-object/from16 v17, v8

    sget-object v8, Landroidx/work/v;->c:Landroidx/work/v;
    ...
    sget-object v11, Landroidx/work/v;->d:Landroidx/work/v;
    ...
    :cond_e
    sget-object v11, Landroidx/work/v;->f:Landroidx/work/v;
    ...
    :cond_f
    :goto_9
    iget-object v6, v6, Ld1/v$b;->a:Ljava/lang/String;
    ...
    invoke-interface {v2, v1}, Ld1/w;->d(Ljava/lang/String;)Ljava/util/List;
    ...
    check-cast v7, Ld1/v$b;

    iget-object v7, v7, Ld1/v$b;->a:Ljava/lang/String;

    invoke-interface {v2, v7}, Ld1/w;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v7}, Landroidx/work/x;->d()Ld1/v;
    ...
    :goto_e
    iput-object v15, v10, Ld1/v;->b:Landroidx/work/v;
    ...
    :cond_19
    sget-object v15, Landroidx/work/v;->e:Landroidx/work/v;

    goto :goto_e

    :cond_1a
    iput-wide v3, v10, Ld1/v;->n:J

    :goto_f
    iget-object v15, v10, Ld1/v;->b:Landroidx/work/v;
    ...
    invoke-static {v15, v10}, Le1/e;->c(Ljava/util/List;Ld1/v;)Ld1/v;

    move-result-object v10

    invoke-interface {v2, v10}, Ld1/w;->q(Ld1/v;)V
    ...
    invoke-direct {v0, v2, v15}, Ld1/a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->D()Ld1/b;

    move-result-object v2

    invoke-interface {v2, v0}, Ld1/b;->a(Ld1/a;)V
    ...
    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->J()Ld1/a0;
    ...
    invoke-interface {v0, v2, v10}, Ld1/a0;->b(Ljava/lang/String;Ljava/util/Set;)V

    if-eqz v9, :cond_1d

    invoke-virtual {v5}, Landroidx/work/impl/WorkDatabase;->G()Ld1/o;
    ...
    invoke-direct {v2, v1, v7}, Ld1/n;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v0, v2}, Ld1/o;->a(Ld1/n;)V
...
.method private static e(Landroidx/work/impl/x;)Z
    ...
    invoke-static {v2}, Le1/d;->e(Landroidx/work/impl/x;)Z
    ...
    :cond_1
    invoke-static {p0}, Le1/d;->b(Landroidx/work/impl/x;)Z
...
.method public a()Z
    ...
    iget-object v0, p0, Le1/d;->a:Landroidx/work/impl/x;
    ...
    :try_start_0
    iget-object v1, p0, Le1/d;->a:Landroidx/work/impl/x;

    invoke-static {v1}, Le1/d;->e(Landroidx/work/impl/x;)Z
...
.method public d()Landroidx/work/p;
    ...
    iget-object v0, p0, Le1/d;->b:Landroidx/work/impl/o;
...
.method public run()V
    ...
    iget-object v2, p0, Le1/d;->a:Landroidx/work/impl/x;
    ...
    iget-object v1, p0, Le1/d;->b:Landroidx/work/impl/o;
