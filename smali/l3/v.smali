...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ll3/v;->d:Lcom/google/android/gms/internal/fido/zzau;

    new-instance v0, Ll3/v0;

    invoke-direct {v0}, Ll3/v0;-><init>()V

    sput-object v0, Ll3/v;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>(Ljava/lang/String;[BLjava/util/List;)V
    ...
    :try_start_0
    invoke-static {p1}, Ll3/z;->h(Ljava/lang/String;)Ll3/z;

    move-result-object p1

    iput-object p1, p0, Ll3/v;->a:Ll3/z;
    :try_end_0
    .catch Ll3/z$a; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object p1, p0, Ll3/v;->b:[B

    iput-object p3, p0, Ll3/v;->c:Ljava/util/List;
...
.method public A()Ljava/lang/String;
    ...
    iget-object v0, p0, Ll3/v;->a:Ll3/z;

    invoke-virtual {v0}, Ll3/z;->toString()Ljava/lang/String;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p1, Ll3/v;->a:Ll3/z;
    ...
    :cond_1
    iget-object v0, p0, Ll3/v;->b:[B

    iget-object v2, p1, Ll3/v;->b:[B
    ...
    :cond_2
    iget-object v0, p0, Ll3/v;->c:Ljava/util/List;

    const/4 v2, 0x1

    if-nez v0, :cond_4

    iget-object v3, p1, Ll3/v;->c:Ljava/util/List;
    ...
    iget-object p1, p1, Ll3/v;->c:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Ll3/v;->a:Ll3/z;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    iget-object v1, p0, Ll3/v;->b:[B
    ...
    iget-object v1, p0, Ll3/v;->c:Ljava/util/List;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p0}, Ll3/v;->A()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ll3/v;->z()Ljava/util/List;
