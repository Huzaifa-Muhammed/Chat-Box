...
.method constructor <init>(Landroid/content/Context;Ln2/a;Ln2/a;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/google/android/datatransport/cct/d;-><init>(Landroid/content/Context;Ln2/a;Ln2/a;I)V

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Ln2/a;Ln2/a;I)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-static {}, Lc2/j;->b()Lm4/a;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/datatransport/cct/d;->a:Lm4/a;
    ...
    iput-object p3, p0, Lcom/google/android/datatransport/cct/d;->e:Ln2/a;

    iput-object p2, p0, Lcom/google/android/datatransport/cct/d;->f:Ln2/a;
...
.method private e(Lcom/google/android/datatransport/cct/d$a;)Lcom/google/android/datatransport/cct/d$b;
    ...
    invoke-static {v1, v2, v0}, Lh2/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :try_start_2
    iget-object v9, p0, Lcom/google/android/datatransport/cct/d;->a:Lm4/a;

    iget-object p1, p1, Lcom/google/android/datatransport/cct/d$a;->b:Lc2/j;
    ...
    invoke-interface {v9, p1, v10}, Lm4/a;->a(Ljava/lang/Object;Ljava/io/Writer;)V
    :try_end_2
    ...
    .catch Lm4/b; {:try_start_4 .. :try_end_4} :catch_1
    ...
    invoke-static {v1, v8, v7}, Lh2/a;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v7, v4}, Lh2/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v2}, Lc2/n;->b(Ljava/io/Reader;)Lc2/n;

    move-result-object v2

    invoke-virtual {v2}, Lc2/n;->c()J
    ...
    .catch Lm4/b; {:try_start_e .. :try_end_e} :catch_1
    ...
    invoke-static {v1, v0, p1}, Lh2/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static f(Landroid/net/NetworkInfo;)I
    ...
    sget-object p0, Lc2/o$b;->b:Lc2/o$b;

    :goto_0
    invoke-virtual {p0}, Lc2/o$b;->h()I
    ...
    :cond_1
    invoke-static {p0}, Lc2/o$b;->d(I)Lc2/o$b;
...
.method private static g(Landroid/net/NetworkInfo;)I
    ...
    sget-object p0, Lc2/o$c;->z:Lc2/o$c;

    invoke-virtual {p0}, Lc2/o$c;->h()I
...
.method private static h(Landroid/content/Context;)I
    ...
    invoke-static {v0, v1, p0}, Lh2/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private i(Le2/f;)Lc2/j;
    ...
    invoke-virtual {p1}, Le2/f;->b()Ljava/lang/Iterable;
    ...
    invoke-virtual {v1}, Ld2/i;->j()Ljava/lang/String;
    ...
    invoke-static {}, Lc2/m;->a()Lc2/m$a;

    move-result-object v3

    sget-object v4, Lc2/p;->b:Lc2/p;

    invoke-virtual {v3, v4}, Lc2/m$a;->f(Lc2/p;)Lc2/m$a;

    move-result-object v3

    iget-object v4, p0, Lcom/google/android/datatransport/cct/d;->f:Ln2/a;

    invoke-interface {v4}, Ln2/a;->a()J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Lc2/m$a;->g(J)Lc2/m$a;

    move-result-object v3

    iget-object v4, p0, Lcom/google/android/datatransport/cct/d;->e:Ln2/a;

    invoke-interface {v4}, Ln2/a;->a()J

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Lc2/m$a;->h(J)Lc2/m$a;
    ...
    sget-object v5, Lc2/k$b;->c:Lc2/k$b;

    invoke-virtual {v4, v5}, Lc2/k$a;->c(Lc2/k$b;)Lc2/k$a;

    move-result-object v4

    invoke-static {}, Lc2/a;->a()Lc2/a$a;

    move-result-object v5

    const-string v6, "sdk-version"

    invoke-virtual {v2, v6}, Ld2/i;->g(Ljava/lang/String;)I
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->m(Ljava/lang/Integer;)Lc2/a$a;

    move-result-object v5

    const-string v6, "model"

    invoke-virtual {v2, v6}, Ld2/i;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v5, v6}, Lc2/a$a;->j(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->f(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->d(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->l(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->k(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->h(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->e(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->c(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->g(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v6}, Lc2/a$a;->i(Ljava/lang/String;)Lc2/a$a;
    ...
    invoke-virtual {v5, v2}, Lc2/a$a;->b(Ljava/lang/String;)Lc2/a$a;

    move-result-object v2

    invoke-virtual {v2}, Lc2/a$a;->a()Lc2/a;

    move-result-object v2

    invoke-virtual {v4, v2}, Lc2/k$a;->b(Lc2/a;)Lc2/k$a;

    move-result-object v2

    invoke-virtual {v2}, Lc2/k$a;->a()Lc2/k;

    move-result-object v2

    invoke-virtual {v3, v2}, Lc2/m$a;->b(Lc2/k;)Lc2/m$a;
    ...
    invoke-virtual {v2, v3}, Lc2/m$a;->i(I)Lc2/m$a;
    :try_end_0
    ...
    invoke-virtual {v2, v3}, Lc2/m$a;->j(Ljava/lang/String;)Lc2/m$a;
    ...
    invoke-virtual {v4}, Ld2/i;->e()Ld2/h;

    move-result-object v5

    invoke-virtual {v5}, Ld2/h;->b()Lb2/c;

    move-result-object v6

    const-string v7, "proto"

    invoke-static {v7}, Lb2/c;->b(Ljava/lang/String;)Lb2/c;

    move-result-object v7

    invoke-virtual {v6, v7}, Lb2/c;->equals(Ljava/lang/Object;)Z

    move-result v7

    if-eqz v7, :cond_2

    invoke-virtual {v5}, Ld2/h;->a()[B

    move-result-object v5

    invoke-static {v5}, Lc2/l;->j([B)Lc2/l$a;
    ...
    invoke-static {v6}, Lc2/l;->i(Ljava/lang/String;)Lc2/l$a;

    move-result-object v5

    :goto_4
    invoke-virtual {v4}, Ld2/i;->f()J

    move-result-wide v6

    invoke-virtual {v5, v6, v7}, Lc2/l$a;->c(J)Lc2/l$a;

    move-result-object v6

    invoke-virtual {v4}, Ld2/i;->k()J

    move-result-wide v7

    invoke-virtual {v6, v7, v8}, Lc2/l$a;->d(J)Lc2/l$a;

    move-result-object v6

    const-string v7, "tz-offset"

    invoke-virtual {v4, v7}, Ld2/i;->h(Ljava/lang/String;)J

    move-result-wide v7

    invoke-virtual {v6, v7, v8}, Lc2/l$a;->h(J)Lc2/l$a;
    ...
    invoke-virtual {v4, v8}, Ld2/i;->g(Ljava/lang/String;)I

    move-result v8

    invoke-static {v8}, Lc2/o$c;->d(I)Lc2/o$c;

    move-result-object v8

    invoke-virtual {v7, v8}, Lc2/o$a;->c(Lc2/o$c;)Lc2/o$a;
    ...
    invoke-static {v8}, Lc2/o$b;->d(I)Lc2/o$b;

    move-result-object v8

    invoke-virtual {v7, v8}, Lc2/o$a;->b(Lc2/o$b;)Lc2/o$a;

    move-result-object v7

    invoke-virtual {v7}, Lc2/o$a;->a()Lc2/o;

    move-result-object v7

    invoke-virtual {v6, v7}, Lc2/l$a;->e(Lc2/o;)Lc2/l$a;

    invoke-virtual {v4}, Ld2/i;->d()Ljava/lang/Integer;
    ...
    invoke-virtual {v5, v4}, Lc2/l$a;->b(Ljava/lang/Integer;)Lc2/l$a;

    :cond_3
    invoke-virtual {v5}, Lc2/l$a;->a()Lc2/l;
    ...
    invoke-static {v4, v5, v6}, Lh2/a;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    goto/16 :goto_3

    :cond_5
    invoke-virtual {v2, v3}, Lc2/m$a;->c(Ljava/util/List;)Lc2/m$a;

    invoke-virtual {v2}, Lc2/m$a;->a()Lc2/m;
    ...
    :cond_6
    invoke-static {p1}, Lc2/j;->a(Ljava/util/List;)Lc2/j;
...
.method private static synthetic l(Lcom/google/android/datatransport/cct/d$a;Lcom/google/android/datatransport/cct/d$b;)Lcom/google/android/datatransport/cct/d$a;
    ...
    invoke-static {v1, v2, v0}, Lh2/a;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public a(Ld2/i;)Ld2/i;
    ...
    invoke-virtual {p1}, Ld2/i;->l()Ld2/i$a;
    ...
    invoke-virtual {p1, v2, v1}, Ld2/i$a;->a(Ljava/lang/String;I)Ld2/i$a;
    ...
    invoke-virtual {p1, v2, v1}, Ld2/i$a;->c(Ljava/lang/String;Ljava/lang/String;)Ld2/i$a;
    ...
    invoke-virtual {p1, v3, v1, v2}, Ld2/i$a;->b(Ljava/lang/String;J)Ld2/i$a;
    ...
    invoke-virtual {p1, v1, v0}, Ld2/i$a;->a(Ljava/lang/String;I)Ld2/i$a;
    ...
    invoke-virtual {p1, v1, v0}, Ld2/i$a;->c(Ljava/lang/String;Ljava/lang/String;)Ld2/i$a;
...
.method public b(Le2/f;)Le2/g;
    .locals 4

    invoke-direct {p0, p1}, Lcom/google/android/datatransport/cct/d;->i(Le2/f;)Lc2/j;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/datatransport/cct/d;->d:Ljava/net/URL;

    invoke-virtual {p1}, Le2/f;->c()[B
    ...
    invoke-direct {v2, v1, v0, v3}, Lcom/google/android/datatransport/cct/d$a;-><init>(Ljava/net/URL;Lc2/j;Ljava/lang/String;)V
    ...
    invoke-static {p1, v2, v0, v1}, Li2/b;->a(ILjava/lang/Object;Li2/a;Li2/c;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Le2/g;->e(J)Le2/g;
    ...
    invoke-static {v0, v1, p1}, Lh2/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
