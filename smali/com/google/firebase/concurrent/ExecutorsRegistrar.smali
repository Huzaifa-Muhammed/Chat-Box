...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lg4/x;-><init>(Ld5/b;)V

    sput-object v0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->a:Lg4/x;
    ...
    sput-object v0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->b:Lg4/x;
    ...
    sput-object v0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->c:Lg4/x;
    ...
    sput-object v0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->d:Lg4/x;
...
.method public static synthetic a(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0

    invoke-static {p0}, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->m(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static synthetic e(Lg4/e;)Ljava/util/concurrent/Executor;
    .locals 0

    invoke-static {p0}, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->o(Lg4/e;)Ljava/util/concurrent/Executor;
...
.method public static synthetic f(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0

    invoke-static {p0}, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->n(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static synthetic h(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0

    invoke-static {p0}, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->l(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method private static i()Landroid/os/StrictMode$ThreadPolicy;
    ...
    invoke-static {v0}, Lh4/a;->a(Landroid/os/StrictMode$ThreadPolicy$Builder;)Landroid/os/StrictMode$ThreadPolicy$Builder;

    const/16 v2, 0x1a

    if-lt v1, v2, :cond_0

    invoke-static {v0}, Lh4/b;->a(Landroid/os/StrictMode$ThreadPolicy$Builder;)Landroid/os/StrictMode$ThreadPolicy$Builder;
...
.method private static synthetic l(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0

    sget-object p0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->a:Lg4/x;

    invoke-virtual {p0}, Lg4/x;->get()Ljava/lang/Object;
...
.method private static synthetic m(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0

    sget-object p0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->c:Lg4/x;
...
.method private static synthetic n(Lg4/e;)Ljava/util/concurrent/ScheduledExecutorService;
    .locals 0

    sget-object p0, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->b:Lg4/x;
...
.method private static synthetic o(Lg4/e;)Ljava/util/concurrent/Executor;
    .locals 0

    sget-object p0, Lh4/o;->a:Lh4/o;
...
.method private static u(Ljava/util/concurrent/ExecutorService;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sget-object v1, Lcom/google/firebase/concurrent/ExecutorsRegistrar;->d:Lg4/x;

    invoke-virtual {v1}, Lg4/x;->get()Ljava/lang/Object;
...
.method public getComponents()Ljava/util/List;
    ...
    invoke-static {v4, v6}, Lg4/f0;->a(Ljava/lang/Class;Ljava/lang/Class;)Lg4/f0;
    ...
    invoke-static {v1, v3}, Lg4/c;->d(Lg4/f0;[Lg4/f0;)Lg4/c$b;
    ...
    invoke-static {v1, v3}, Lg4/f0;->a(Ljava/lang/Class;Ljava/lang/Class;)Lg4/f0;
    ...
    invoke-static {v4, v7}, Lg4/f0;->a(Ljava/lang/Class;Ljava/lang/Class;)Lg4/f0;
    ...
    invoke-static {v1}, Lg4/c;->c(Lg4/f0;)Lg4/c$b;
    ...
    invoke-virtual {v1, v2}, Lg4/c$b;->e(Lg4/h;)Lg4/c$b;
