...
.method constructor <init>(Lcom/google/firebase/storage/p;)V
    ...
    iput-object v6, p0, Lcom/google/firebase/storage/h0;->m:Lo5/c;
...
.method static synthetic m0(Lcom/google/firebase/storage/h0;)Lp5/e;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;

    return-object p0
.end method

.method static synthetic n0(Lcom/google/firebase/storage/h0;Lp5/e;)Lp5/e;
    .locals 0

    iput-object p1, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;
...
.method private o0()Ljava/io/InputStream;
    ...
    iget-object v0, p0, Lcom/google/firebase/storage/h0;->m:Lo5/c;

    invoke-virtual {v0}, Lo5/c;->c()V

    iget-object v0, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lp5/c;-><init>(Lo5/h;Ly3/f;J)V

    iput-object v0, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;

    iget-object v1, p0, Lcom/google/firebase/storage/h0;->m:Lo5/c;

    const/4 v2, 0x0

    invoke-virtual {v1, v0, v2}, Lo5/c;->e(Lp5/e;Z)V

    iget-object v0, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;

    invoke-virtual {v0}, Lp5/e;->o()I
    ...
    invoke-virtual {v0}, Lp5/e;->f()Ljava/lang/Exception;
    ...
    invoke-virtual {v0, v1}, Lp5/e;->q(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lp5/e;->t()Ljava/io/InputStream;
...
.method e0()V
    ...
    :try_start_0
    invoke-static {v4}, Lcom/google/firebase/storage/h0$c;->g(Lcom/google/firebase/storage/h0$c;)Z
    ...
    iget-object v4, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;

    invoke-virtual {v4}, Lp5/e;->C()V

    const/4 v4, 0x0

    iput-object v4, p0, Lcom/google/firebase/storage/h0;->u:Lp5/e;
