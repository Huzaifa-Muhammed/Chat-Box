...
.field static F:Lo5/e;

.field static G:Lf3/d;
...
.field private final o:Lo5/b;

.field private final p:Ljava/util/concurrent/atomic/AtomicLong;

.field private final q:Lf4/b;

.field private final r:Le4/b;

.field private s:I

.field private t:Lo5/c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/storage/n0;->F:Lo5/e;

    invoke-static {}, Lf3/f;->c()Lf3/d;

    move-result-object v0

    sput-object v0, Lcom/google/firebase/storage/n0;->G:Lf3/d;
...
.method constructor <init>(Lcom/google/firebase/storage/p;Lcom/google/firebase/storage/o;Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-virtual {v3}, Lcom/google/firebase/storage/f;->c()Lf4/b;

    move-result-object v6

    iput-object v6, p0, Lcom/google/firebase/storage/n0;->q:Lf4/b;

    invoke-virtual {v3}, Lcom/google/firebase/storage/f;->b()Le4/b;

    move-result-object v7

    iput-object v7, p0, Lcom/google/firebase/storage/n0;->r:Le4/b;

    iput-object p3, p0, Lcom/google/firebase/storage/n0;->m:Landroid/net/Uri;

    invoke-virtual {v3}, Lcom/google/firebase/storage/f;->h()J
    ...
    invoke-virtual {p1}, Lcom/google/firebase/storage/p;->l()Ly3/f;

    move-result-object v4

    invoke-virtual {v4}, Ly3/f;->m()Landroid/content/Context;

    move-result-object v5

    invoke-virtual {v3}, Lcom/google/firebase/storage/f;->k()J

    move-result-wide v8

    move-object v4, p2

    invoke-direct/range {v4 .. v9}, Lo5/c;-><init>(Landroid/content/Context;Lf4/b;Le4/b;J)V

    iput-object p2, p0, Lcom/google/firebase/storage/n0;->t:Lo5/c;
    ...
    invoke-direct {p1, v2, v1}, Lo5/b;-><init>(Ljava/io/InputStream;I)V

    iput-object p1, p0, Lcom/google/firebase/storage/n0;->o:Lo5/b;
...
.method constructor <init>(Lcom/google/firebase/storage/p;Lcom/google/firebase/storage/o;[B)V
    ...
    invoke-virtual {v2}, Lcom/google/firebase/storage/f;->c()Lf4/b;

    move-result-object v7

    iput-object v7, p0, Lcom/google/firebase/storage/n0;->q:Lf4/b;

    invoke-virtual {v2}, Lcom/google/firebase/storage/f;->b()Le4/b;

    move-result-object v8

    iput-object v8, p0, Lcom/google/firebase/storage/n0;->r:Le4/b;
    ...
    invoke-direct {p1, p2, v0}, Lo5/b;-><init>(Ljava/io/InputStream;I)V
    ...
    invoke-virtual {v2}, Lcom/google/firebase/storage/f;->h()J
    ...
    invoke-virtual {v2}, Lcom/google/firebase/storage/f;->a()Ly3/f;
    ...
    invoke-direct/range {v5 .. v10}, Lo5/c;-><init>(Landroid/content/Context;Lf4/b;Le4/b;J)V

    iput-object p1, p0, Lcom/google/firebase/storage/n0;->t:Lo5/c;

    return-void
.end method

.method static synthetic l0(Lcom/google/firebase/storage/n0;)Lf4/b;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/storage/n0;->q:Lf4/b;

    return-object p0
.end method

.method static synthetic m0(Lcom/google/firebase/storage/n0;)Le4/b;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/storage/n0;->r:Le4/b;
...
.method private o0()V
    ...
    invoke-virtual {v0}, Lcom/google/firebase/storage/f;->a()Ly3/f;
    ...
    invoke-virtual {v3}, Lcom/google/firebase/storage/p;->w()Lo5/h;

    move-result-object v3

    iget-object v4, p0, Lcom/google/firebase/storage/n0;->l:Lcom/google/firebase/storage/p;

    invoke-virtual {v4}, Lcom/google/firebase/storage/p;->l()Ly3/f;
    ...
    :cond_3
    invoke-direct {v2, v3, v4, v1, v0}, Lp5/j;-><init>(Lo5/h;Ly3/f;Lorg/json/JSONObject;Ljava/lang/String;)V

    invoke-direct {p0, v2}, Lcom/google/firebase/storage/n0;->v0(Lp5/e;)Z
    ...
    invoke-virtual {v2, v0}, Lp5/e;->q(Ljava/lang/String;)Ljava/lang/String;
...
.method private p0(Lp5/e;)Z
    ...
    sget-object v2, Lcom/google/firebase/storage/n0;->F:Lo5/e;
    ...
    invoke-interface {v2, v3}, Lo5/e;->a(I)V
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-direct {p0, p1}, Lcom/google/firebase/storage/n0;->u0(Lp5/e;)Z
...
.method private s0(Lp5/e;)Z
    .locals 2

    invoke-virtual {p1}, Lp5/e;->o()I

    move-result v0

    iget-object v1, p0, Lcom/google/firebase/storage/n0;->t:Lo5/c;

    invoke-virtual {v1, v0}, Lo5/c;->b(I)Z
    ...
    invoke-virtual {p1}, Lp5/e;->f()Ljava/lang/Exception;
    ...
    invoke-virtual {p1, v0}, Lp5/e;->q(Ljava/lang/String;)Ljava/lang/String;
...
.method private t0(Z)Z
    ...
    invoke-virtual {v2}, Lcom/google/firebase/storage/p;->w()Lo5/h;

    move-result-object v2

    iget-object v3, p0, Lcom/google/firebase/storage/n0;->l:Lcom/google/firebase/storage/p;

    invoke-virtual {v3}, Lcom/google/firebase/storage/p;->l()Ly3/f;

    move-result-object v3

    iget-object v4, p0, Lcom/google/firebase/storage/n0;->w:Landroid/net/Uri;

    invoke-direct {v1, v2, v3, v4}, Lp5/i;-><init>(Lo5/h;Ly3/f;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, v1}, Lcom/google/firebase/storage/n0;->v0(Lp5/e;)Z
    ...
    :cond_1
    invoke-direct {p0, v1}, Lcom/google/firebase/storage/n0;->u0(Lp5/e;)Z
    ...
    invoke-virtual {v1, p1}, Lp5/e;->q(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object p1, p0, Lcom/google/firebase/storage/n0;->o:Lo5/b;

    sub-long v7, v1, v5

    long-to-int v3, v7

    invoke-virtual {p1, v3}, Lo5/b;->a(I)I
...
.method private u0(Lp5/e;)Z
    .locals 3

    iget-object v0, p0, Lcom/google/firebase/storage/n0;->q:Lf4/b;

    invoke-static {v0}, Lo5/i;->c(Lf4/b;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/google/firebase/storage/n0;->r:Le4/b;

    invoke-static {v1}, Lo5/i;->b(Le4/b;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Ly3/f;->m()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {p1, v0, v1, v2}, Lp5/e;->B(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V

    invoke-direct {p0, p1}, Lcom/google/firebase/storage/n0;->s0(Lp5/e;)Z
...
.method private v0(Lp5/e;)Z
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/storage/n0;->t:Lo5/c;

    invoke-virtual {v0, p1}, Lo5/c;->d(Lp5/e;)V
...
.method private x0()Z
    ...
    :goto_1
    sget-object v4, Lcom/google/firebase/storage/n0;->G:Lf3/d;

    invoke-interface {v4}, Lf3/d;->b()J
    ...
    sget-object v6, Lcom/google/firebase/storage/n0;->G:Lf3/d;

    invoke-interface {v6}, Lf3/d;->b()J
...
.method private z0()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/storage/n0;->o:Lo5/b;

    iget v2, p0, Lcom/google/firebase/storage/n0;->s:I

    invoke-virtual {v1, v2}, Lo5/b;->d(I)I

    iget v1, p0, Lcom/google/firebase/storage/n0;->s:I

    iget-object v2, p0, Lcom/google/firebase/storage/n0;->o:Lo5/b;
    ...
    iget-object v3, p0, Lcom/google/firebase/storage/n0;->o:Lo5/b;

    invoke-virtual {v3}, Lo5/b;->e()[B
    ...
    invoke-direct/range {v3 .. v11}, Lp5/g;-><init>(Lo5/h;Ly3/f;Landroid/net/Uri;[BJIZ)V

    invoke-direct {p0, v2}, Lcom/google/firebase/storage/n0;->p0(Lp5/e;)Z
    ...
    invoke-virtual {v2, v1}, Lo5/b;->a(I)I
    ...
    invoke-virtual {v2}, Lp5/e;->n()Lorg/json/JSONObject;
    ...
    invoke-virtual {v2}, Lp5/e;->m()Ljava/lang/String;
...
.method protected U()V
    ...
    invoke-direct {v0, v1, v2, v3}, Lp5/h;-><init>(Lo5/h;Ly3/f;Landroid/net/Uri;)V
    ...
    invoke-direct {v2, p0, v0}, Lcom/google/firebase/storage/n0$a;-><init>(Lcom/google/firebase/storage/n0;Lp5/e;)V
...
.method e0()V
    ...
    invoke-virtual {v2}, Lcom/google/firebase/storage/p;->s()Lcom/google/firebase/storage/p;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/storage/n0;->o:Lo5/b;
